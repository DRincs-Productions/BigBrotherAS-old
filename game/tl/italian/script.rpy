...
translate italian intro_8dea4dcf:
    ...
    Max_00 "Mi chiamo Max. Sono un ragazzo normale di una famiglia normale. Beh, come al solito... Normale. Anche se, chi voglio prendere in giro. Normale nella mia famiglia non è abbastanza. Ma prima le cose importanti." nointeract
...
translate italian intro_0f762891:
    ...
    Max_01 "Sono stato recentemente cacciato da scuola. Ufficialmente - per i brutti voti. Anche se i miei voti erano così così, la vera ragione era l'insegnante di matematica. Dicono che ci ho provato con... Mi stava facendo gli occhi dolci! Al preside, suo marito, non è piaciuto per qualche motivo..."
...
translate italian intro_4e148ae4:
    ...
    Max_14 "In pratica, ora ho un'istruzione secondaria incompleta. Senza lavoro e progetti concreti per il futuro... Ma tutto deve cambiare, senza dubbio!"
...
translate italian intro_1c9ab78c:
    ...
    Max_04 "Questa è Anna, mia madre. Ha cresciuto me e le mie due sorelle per diversi anni. Lavora nell'ufficio di un'azienda. Anche se, il suo stipendio è abbastanza decente, ma quasi tutto se ne và per l'alloggio in affitto, il cibo e i vestiti."
...
translate italian intro_cb16881c:
    ...
    Max_00 "Bene, questo è il nostro appartamento. Che catapecchia! La mamma sta provando a trovare un acconto per prendere un mutuo, ma finora qualcosa non ha funzionato. Tutti sogniamo di trasferirci, ma dove?"
...
translate italian intro_4547bbbc:
    ...
    Max_08 "Alice, la mia sorella maggiore. Si è da poco laureata e, come me, sta cercando la sua strada. Tutto il giorno resta seduta davanti al suo laptop e lavora a qualche blog tutto suo. Come spesso accade tra fratelli e sorelle maggiori, non andiamo molto d'accordo..."
...
translate italian intro_75876970:
    ...
    Max_00 "Lisa, la mia sorellina, và ancora a scuola. Non so come và, ma se non è stata cacciata via come me, va bene. Lisa ed io siamo sulla stessa lunghezza d'onda, anche se ogni tanto litighiamo. Ma se succede qualcosa, sono io che cerco protezione."
...
translate italian intro_165806c1:
    ...
    Ann_00 "Ciao, sì, certo. Mi chiamo Anna, ma immagino che tu lo sappia già. Allora, cosa c'è? Gli è successo qualcosa?"
...
translate italian intro_a97592f1:
    ...
    Maya_02 "Ho portato i documenti per la proprietà, che ha deciso di consegnarvi. Se li firmate, diventerete i legittimi proprietari."

# game/script.rpy:78
translate italian intro_8b0c7301:

    # Ann_17 "Что-то я не поняла. Это совсем на него не похоже. Какая недвижимость? О чём речь?"
    Ann_17 "Non capisco. Non sembra affatto da lui. Quali immobili? Di cosa si tratta?"
...
translate italian intro_ce5a5dae:
    ...
    Maya_01 "È una casa a due piani nel sud del paese che la sua azienda ha costruito. E per quanto riguarda il fatto che non sembri lui... È cambiato molto negli ultimi due anni. Non sono sicura che questi cambiamenti siano stati positivi per gli affari."
...
translate italian intro_43a9e56e:
    ...
    Ann_01 "Mi hai lasciato perplessa. Qual è la fregatura? Ti devo qualcosa? Tutti questi anni, nessuna notizia, niente, e poi... una casa. E i suoi affari?"
...
translate italian intro_60f50736:
    ...
    Maya_02 "Al momento ha venduto la maggior parte della proprietà per pagare i suoi debiti fiscali, ma ha deciso di lasciarti questa casa a te. Non conosco le ragioni e non mi riguardano."
...
translate italian intro_ea2ebd5a:
    ...
    Ann_00 "Sai, Maya, non posso accettare un tale... regalo. Prima di tutto, non sono al corrente delle sue macchinazioni o di qualsiasi cosa abbia in mente, e in secondo luogo, non ci parliamo da tanti anni e non voglio niente da lui!"
...
translate italian intro_734c8765:
    ...
    Maya_01 "Sì, mi ha avvertito della tua reazione... Da un punto di vista legale, la casa è completamente pulita e non si rischia nulla. Inoltre, i vostri figli stanno crescendo e hanno bisogno del loro spazio, della loro privacy..."

# game/script.rpy:84
translate italian intro_8db9c9f1:

    # Ann_14 "С этим не поспоришь. У меня есть время подумать обо всём?"
    Ann_14 "Su questo non posso discutere. Ho tempo di pensarci?"
...
translate italian intro_eaf717b9:
    ...
    Max_04 "Fortunatamente, mia madre ha preso la decisione giusta. Quando abbiamo visto la casa, non potevamo credere ai nostri occhi! Dal vivo era molto più grande e più bello che nelle foto. Ma la sorpresa migliore è stata la piscina!"
...
translate italian intro_afbd2795:
    ...
    Max_00 "Alice prese immediatamente una delle camere da letto. A proposito, ce n'erano solo due. Nonostante l'enorme soggiorno con cucina e lo spazioso bagno, ci sono solo tre stanze separate nella casa: due camere da letto e uno studio."
...
translate italian intro_5fc10bfc:
    ...
    Max_08 "Non c'era quasi nessun mobile nello studio, e ho avuto la grande idea di mettere qui il mio letto e quello di Lisa del vecchio appartamento."
...
translate italian intro_c174fdf7:
    ...
    Ann_01 "Non mi piace questa tua idea, Max. Siete troppo grandi per dormire nella stessa stanza. Lasciamo a te l'ufficio e a Lisa l'altra camera da letto. Dormirò in salotto. C'è un bel divano lì..."
...
translate italian intro_8132e149:
    ...
    Max_01 "Mamma, abbiamo dovuto tutti come aringhe in un barile, ci siamo abituati. E queste stanze sono così grandi. Lisa e io abbiamo abbastanza spazio. Giusto, sorellina?"
...
translate italian intro_fbedb073:
    ...
    Lisa_02 "Certo! Mamma, io e Max andiamo d'accordo. E se sbaglia, lo sbatto fuori in salotto! E ti meriti davvero la tua stanza. E non discutere. Questo è quello che pensiamo tutti."
...
translate italian intro_dbd412b7:
    ...
    Max_00 "La settimana dopo sono state consegnate alcune delle nostre cose del vecchio appartamento. Ma solo in parte. Da quanto ho capito, alcune cose si sono perse per strada. Spero che rimedieranno in qualche modo..."
...
translate italian about_poss_0cd5a085:
    ...
    Max_00 "\"Opportunità\" sono percorsi speciali che possono essere seguiti per raggiungere un certo tipo di risultato. Di solito sono nascosti e non molto evidenti."
...
translate italian about_poss_0f75481c:
    ...
    Max_03 "Certe azioni nel gioco aprono tali \"opportunità\". Potete vederli nella apposita schermata, che può essere aperta tramite il menu in alto."
...
translate italian about_poss_09cf07b7:
    ...
    Max_00 "Alcune \"opportunità\" sono temporanee. Alcune possono portare a risultati indesiderati. Non prendere la prima che vedi e segui ciecamente le indicazioni!"
...
translate italian strings:
    ...
    new "{i}Ripetere il prologo{/i}"

    # game/script.rpy:121
    old "{i}всё ясно{/i}"
    new "{i}è tutto chiaro{/i}"
