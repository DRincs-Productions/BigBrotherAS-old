...
translate italian strings:
    ...
    new "La zia Kira è un'eccellente insegnante di baci! Ha accettato di insegnarmi qualche volta. Chissà, forse mi insegnerà anche qualcos'altro?\n\nQuesto è tutto. Ora devo fare pratica di baci con la zia Kira e passarlo a Lisa... Solo che ha ancora bisogno di essere convinta..."
    ...
    new "Ho parlato con Lisa per insegnarle. Ha imposto una serie di condizioni, tra cui non permettermi di toccarla se lei è contraria. Beh, è già qualcosa."
    ...
    new "Sono riuscito a impressionare Lisa con le mie capacità di bacio! Non era ancora veramente arte, ma le piaceva molto! Dopo tutto, zia Kira è una grande insegnante. Ma bisogna continuare a fare pratica."
    ...
    new "Ho dato a Lisa un libro che contiene molte risposte alle sue domande. Sarebbe stato utile per me leggerlo da solo, ma sono troppo pigro.\n\n\nDovrò chiederle tra un po' cosa pensa del libro..."
    ...
    new "Ho detto a zia Kira tutto di Eric, proprio così. Sembrava dubitare delle mie parole, ma ha promesso di indagare attentamente e scoprirlo. Forse parlerebbe anche con Eric stesso..."
    ...
    new "Kira si è offerta di prepararmi dei soldi. Tutto quello che devo fare è fotografarla. L'unica cosa di cui ho bisogno è una macchina fotografica per questo scopo. Certo, non è probabile che mi paghi quanto costa la macchina fotografica, ma c'è la possibilità che io ottenga qualcos'altro per il servizio fotografico..."
    ...
    new "Allora, le foto sono venute bene e io e Kira abbiamo accettato di fare un altro servizio fotografico mentre nessuno è in casa. Ma non è ancora chiaro quando lo faremo... Chissà cosa vuole ottenere Kira per il servizio fotografico! Non ci resta che aspettare..."

    # game/core/oldfix.rpy:380
    old "А ещё, будет не лишним, купить для этой фотосессии сексуальную сорочку для моей любимой тёти!"
    new "Inoltre, non sarebbe male comprare una camicia sexy per questo servizio fotografico per la mia zia preferita!"
    ...
    new "Di cosa si trattava? Mia madre mi ha beccato a sbirciare mentre scopavano, stava per punirmi, ma Eric ha detto di no e mia madre ha accettato? Mia madre, che non mi lasciava nemmeno guardare l'erotismo, ha accettato di lasciarmi essere lì per questo? Questo è incredibile. O Eric è una specie di stregone, o è qualcos'altro e dobbiamo andare a fondo della questione."
    ...
    new "Mi è capitato di vedere Eric in piedi vicino alla finestra della stanza di Alice nel mezzo della notte, mentre si masturbava su di lei! Non mi aspettavo di vedere questo... Pensavo che Erik avrebbe preferito una prostituta piuttosto che farsi una sega, ma a quanto pare... Mi sbagliavo.\n\nScommetto che non è la prima volta che lo fa! Dovremo osservarlo di notte per avere un quadro delle sue sporche azioni... Meglio avere una carta vincente contro di lui, nel caso succeda qualcosa..."
