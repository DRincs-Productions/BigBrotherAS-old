...
translate italian strings:
    ...
    new "{color=#00FF00}{i}Fortuna!{/i}{/color}\n"
    ...
    new "{color=#E59400}{i}Sei stato notato!{/i}{/color}\n"
    ...
    new "{color=#E59400}{i}Sfortuna!{/i}{/color}\n"
    ...
    new "{color=#FFBE00}{b}Attenzione:{/b} La tua influenza sulle presenti è diminuita!{/color}\n"

    # game/core/02init.rpy:41
    ...
    new "{color=#00FF00}{i}Successo!{/i}{/color}\n"

    # game/core/02init.rpy:44
    old "{color=#E59400}{i}Провал!{/i}{/color}\n"
    new "{color=#E59400}{i}Fallimento!{/i}{/color}\n"

    # game/core/02init.rpy:96
    old "ВС"
    new "DOM"
    ...
    new "Scusa, ma ti ho visto per caso mentre facevi la doccia..."

    # game/core/02init.rpy:152
    old "Хочу извиниться. Я бессовестно подглядывал за тобой утром..."
    new "Voglio scusarmi. Stamattina ti stavo vergognosamente spiando..."
    ...
    new "Come stai dopo quello che è successo?"

    # game/core/02init.rpy:152
    old "Я пришёл извиниться за то, что было утром. Я больше не буду."
    new "Sono venuto a scusarmi per quello che è successo stamattina. Non lo farò più."

    # game/core/02init.rpy:152
    old "Я снова подглядывал. Извини."
    new "Ti stavo spiando di nuovo. Mi dispiace."

    # game/core/02init.rpy:152
    old "Ну давай, можешь меня наказывать..."
    new "Avanti, puoi punirmi..."

    # game/core/02init.rpy:152
    old "Я выбираю наказание от тебя..."
    new "Scelgo di essere punito da te..."

    # game/core/02init.rpy:152
    old "Мам, дай денег, пожалуйста..."
    new "Mamma, mi dai dei soldi, per favore..."
    ...
    new "Mamma, dobbiamo parlare di Olivia."

    # game/core/02init.rpy:152
    old "Мам, ты подумала об Оливии?"
    new "Mamma, hai pensato a Olivia?"
    ...
    new "Il mio premio per aiutare Lisa!"

    # game/core/02init.rpy:152
    old "Чтобы на маме были не только очки для сна, но и чулки!"
    new "Che mia madre non aveva solo gli occhiali per dormire, ma anche le calze!"

    # game/core/02init.rpy:152
    old "Чтобы на маме были только очки для сна!"
    new "Per la mamma aveva solo gli occhiali per dormire!"

    # game/core/02init.rpy:152
    old "Вот деньги, чтобы ты не лез к Лизе..."
    new "Ecco dei soldi per tenerti lontano da Lisa..."

    # game/core/02init.rpy:152
    old "У меня нет денег, чтобы ты не лез к Лизе."
    new "Non ho i soldi per tenerti lontano da Lisa."
    ...
    new "Quando ci sarà un nuovo servizio fotografico, zia Kira?"

    # game/core/02init.rpy:152
    old "Уже слышала новость, тётя Кира?"
    new "Hai già sentito la notizia, zia Kira?"
    ...
    new "Allora, hai fatto tutto di nuovo? \n{i}(per accompagnare Lisa a scuola){/i}"

    # game/core/02init.rpy:152
    old "Лиза, ты чего нос повесила?"
    new "Lisa, perché stai arricciando il naso?"

    # game/core/02init.rpy:152
    old "Мама разрешила!"
    new "La mamma ha detto che potevo!"

    # game/core/02init.rpy:152
    old "Кстати, а как тебе та книжка, которую я дарил?"
    new "A proposito, cosa ne pensi del libro che ti ho dato?"

    # game/core/02init.rpy:152
    old "Можно вместе с тобой книжку почитать?"
    new "Posso leggere un libro con te?"

    # game/core/02init.rpy:152
    old "Можно к тебе присоединиться?"
    new "Posso unirmi a voi?"

    # game/core/02init.rpy:152
    old "А у меня есть крем для загара. Хотите?"
    new "E ho la protezione solare. Ne vuoi un po'?"

    # game/core/02init.rpy:152
    old "Давайте, я намажу вас кремом для загара?"
    new "Perché non ti metto un po' di protezione solare?"

    # game/core/02init.rpy:152
    old "Вам дать крем для загара?"
    new "Vuole una crema solare?"

    # game/core/02init.rpy:152
    old "Мам, поговорим?"
    new "Mamma, possiamo parlare?"

    # game/core/02init.rpy:152
    old "Хотел поговорить о маме..."
    new "Volevo parlare di mia madre..."

    # game/core/02init.rpy:152
    old "Мам, ты подумала?"
    new "Mamma, ci hai pensato?"

    # game/core/02init.rpy:152
    old "Я разжился деньгами! Идём за костюмом?"
    new "Ho i soldi! Andiamo a prendere il vestito?"

    # game/core/02init.rpy:298
    old "Одежда"
    new "Abbigliamento"
    ...
    new "Ho un regalo per te {i}(Completo in pelle){/i}"

    # game/core/02init.rpy:309
    old "У меня для тебя подарок {i}(Плётка){/i}"
    new "Ho un regalo per te {i}(La frusta){/i}"
