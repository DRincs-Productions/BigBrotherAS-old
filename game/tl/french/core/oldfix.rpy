...
translate french old_fix_6c975de3:
...
translate french old_fix_93331e6b:
...
translate french old_fix_93331e6b_1:
...
translate french strings:
    ...
    new "J’ai parlé à Lisa de sa formation. Elle a proposé un certain nombre de conditions, parmi lesquels l'interdiction de la toucher si elle ne veux pas. Eh bien, c'est déjà un début."

    # game/core/oldfix.rpy:292
    old "Похоже обучаться Лиза согласна только если у неё хорошее настроение..."
    new "Lisa ne semble disposée à apprendre que si elle est de bonne humeur..."
    ...
    new "En cherchant sur Internet des informations sur ce qu'Alice pourrait faire, j'ai réussi à découvrir certaines choses. Les blogs les plus populaires sont ceux tenus par des filles. En outre, plus les tenues sont révélatrices et plus les seins sont gros, plus les émissions sont populaires. On ne peut rien faire pour les seins, bien sûr, mais les tenues... Peut-être lui parler de ça ?"
    ...
    new "J'ai donné à Alice un bel ensemble de sous-vêtements. Elle a vraiment aimé ça. Elle l'a même essayé devant moi! C'est vrai, je n'ai presque rien vu, mais c'était excitant... Plus curieusement, elle a laissé entendre que quelque chose de plus... sexe serait mieux!"
    ...
    new "J'ai donné à Alice un bel ensemble de sous-vêtements. Elle a vraiment aimé ça. Certes, je n'ai rien vu, Alice a déjà cette même lingerie, mais même ça, c'était excitant... Plus curieusement, elle a laissé entendre que quelque chose de plus... sexe serait mieux!"
    ...
    new "J'ai donné à Alice un bel ensemble de sous-vêtements. Elle a vraiment aimé ça. Elle l'a même essayé devant moi! Je n'ai pas vu grand-chose, mais c'était excitant... Plus curieusement, elle a laissé entendre que quelque chose de plus... sexe serait mieux!"
    ...
    new "J’ai tout dit à tante Kira sur Eric, c’est comme ça, alors je l’ai dit. Elle semble douter de mes paroles, mais a promis d'enquêter avec soin. Peut-être même qu’Eric lui-même parlera de ses secrets..."
    ...
    new "Kira m’a offert de l’argent. J'ai juste besoin de la prendre en photo. C’est pour ça qu'il me faut un appareil photo. Bien sûr, il est peu probable qu’elle me paie autant que le prix de l’appareil photo, mais il y a une chance que quelque chose d’autre se casse pour cette séance de poses..."
    ...
    new "Donc, les photos sont réussies et Kira et moi avons convenu d’une nouvelle séance photo quand personne ne sera à la maison. Mais on ne sait pas encore quand ce sera... Je me demande ce que Kira veut obtenir pour ce nouveau tournage !? Je ne peux qu’attendre..."

    # game/core/oldfix.rpy:380
    old "А ещё, будет не лишним, купить для этой фотосессии сексуальную сорочку для моей любимой тёти!"
    new "Il ne sera pas superflu d’acheter pour cette séance photo une chemise sexy pour ma tante bien-aimée !"
    ...
    new "Qu'est-ce que c'était que ça? Maman m'a surpris en train de les regarder pendant qu'ils baisaient, elle allait me punir, mais Eric a dit non et maman a accepté! Ma mère, qui m'interdisait de regarder ne serait-ce que des films érotiques, a accepté que j'assiste à cela ? C'est incroyable. Soit Eric est une sorte de sorcier, soit c'est autre chose et il faut que je m'en occupe correctement."
