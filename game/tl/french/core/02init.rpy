...
translate french strings:
    ...
    new "{color=#E59400}{i}maman n’a pas aimé le massage! {/i} {/color}\n"

    # game/core/02init.rpy:43
    old "{color=#00FF00}{i}Успех!{/i}{/color}\n"
    new "{color=#00FF00}{i}Succès!{/i}{/color}\n"
