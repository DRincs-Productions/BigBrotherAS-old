...
translate french strings:
    ...
    new "J'ai trouvé une boîte vide sous la caméra furtive. Apparemment, il y avait quelque chose d'installé. Je dois trouver se qu'il y avait là - j'y pense, Est-ce que quelqu'un nous espionnait tout ce temps?"
    ...
    new "J’ai donc trouvé une caméra furtive dans le salon. Elle était dans le mur, apparemment installée pendant les travaux effectués dans la maison. Par conséquent, elle ne peut pas être retirée sans endommager le mur. De plus, il s’avère que la caméra n’est plus connectée à rien. Peut-être devrais-je explorer les moyens de me connecter à ces caméras pour en tirer avantages..."
    ...
    new "J’ai eu une excellente idée - gagner de l’argent sur la diffusion de la webcam sur Internet, mais j’en sais très peu à ce sujet... Peut-être qu’un peu de littérature aidera?"

    # game/core/09_opportunities.rpy:4
    old "Иногда, специализированные книги куда лучше, чем то, что пишут в интернете! Это как раз такой случай..."
    new "Parfois, les livres spécialisés sont bien meilleurs que ce qui est écrit sur Internet! C’est le cas..."
    ...
    new "J’ai donc lu attentivement le livre Web Standards et j’ai compris comment créer mon site Web. Peut-être devrais-je commencer par ça. J’ai besoin d’argent pour un mon de domaine, l’hébergement et le paiement pour un modèle prêt à l’emploi avec un design. Au total, j'ai besoin d’environ 100 $."

    # game/core/09_opportunities.rpy:4
    old "Главное, собрать нужную сумму, а остальное - уже ерунда..."
    new "L’essentiel est de collecter le montant nécessaire, et le reste suivra..."
    ...
    new "Enfin, Vous avez votre propre site web qui diffuse l’image de la caméra du salon! Maintenant, vous devez augmenter l’audience, car plus il y a de gens, plus les revenus des bannières publicitaires sont importants. Cela peut être fait à l’aide de pièces jointes, pour promouvoir votre site. De plus, si quelque chose d’intéressant se passe sur l'écran, le public grandit également. Pour commencer, il vaut la peine d’installer des caméras dans chaque pièce, ainsi que dans la cour ..."
    ...
    new "Vous devez payer périodiquement pour la publicité pour le site afin d’économiser rapidement de l’argent pour de nouvelles caméras et, alternativement, essayez de mendier quelque chose à Alice, à maman ou à Eric ..."
    ...
    new "Super ! J'ai maintenant des caméras dans chaque pièce ! Les coûts étaient élevés, mais elles seront manifestement rentabilisés, car il y a tant de belles filles dans cette maison qui, de temps en temps, font étalage de leurs charmes... Cependant, cela ne ferait pas de mal de mettre une autre caméra dans la cour, car les filles ne font pas que bronzer, elles se baignent aussi. Pour compléter le tableau, mon public aura certainement envie d'admirer les filles mouillées ! De plus, la couverture de la caméra dans la salle de bain est trop petite, bien que très intéressante. Cela vaut-il la peine d'installer une autre caméra à cet endroit ? Cela devra être vérifié..."

    # game/core/09_opportunities.rpy:4
    old "Лучше начать с поиска хорошего обзора ванной комнаты..."
    new "Il vaut mieux commencer par chercher une bonne vue sur la salle de bain..."

    # game/core/09_opportunities.rpy:4
    old "Вечер - это самое лучшее время, чтобы попробовать подсмотреть за кем-нибудь в ванной комнате и не попасться..."
    new "La soirée est le meilleur moment pour essayer d’espionner quelqu’un dans la salle de bain et ne pas se faire prendre..."

    # game/core/09_opportunities.rpy:4
    old "Стоит понаблюдать, чем обычно все занимаются у зеркала в ванной комнате..."
    new "Il vaut la peine de regarder ce que tout le monde fait habituellement au miroir dans la salle de bain ..."

    # game/core/09_opportunities.rpy:4
    old "Не забыть установить вторую камеру во дворе и в ванной комнате"
    new "N’oubliez pas d’installer une deuxième caméra dans la cour et dans la salle de bain"
    ...
    new "Eh bien, peut-être, neuf caméras seront plus que suffisantes pour gagner beaucoup d’argent! Il ne reste plus qu’à m’assurer que pour chacun d’eux, mes téléspectateurs avaient quelque chose à voir..."
    ...
    new "Alice lit des livres, mais ne veut pas en parler. Ça ne ressemble pas aux magazines pornos... Qu'est-ce que ça pourrait être d'autre ? Je devrais essayer de le découvrir dès que possible... Curieux !"

    # game/core/09_opportunities.rpy:4
    old "Стоит поискать книгу в комнате Алисы..."
    new "Ça vaut le coup de chercher un livre dans la chambre d’Alice..."
    ...
    new "J'ai trouvé un livre, mais le titre n'a aucun sens, et je n'ai ni le temps ni l'envie de lire le livre lui-même. Peut-être qu'il faut chercher sur Internet ?"

    # game/core/09_opportunities.rpy:4
    old "Всё просто! До ноутбука дойти не проблема..."
    new "C’est aussi simple que cela ! Ce n’est pas un problème d’arriver à l’ordinateur portable..."
    ...
    new "Mon Dieu! Je n’étais pas si loin de la vérité. Bien sûr, ce n’est pas le cas, mais certainement de l’érotisme, et même quoi! Apparemment, Alice aime les romans d’amour avec des nuances érotiques, pour ainsi dire. Peut-être devrais-je lui donner un livre comme celui-ci et voir sa réaction?"

    # game/core/09_opportunities.rpy:4
    old "Наверняка удастся найти похожие книги в интернет-магазине. Были бы деньги..."
    new "Je peux probablement trouver des livres similaires dans la boutique en ligne. Si seulement j'avais de l'argent..."
    ...
    new "À en juger par la réaction d’Alice, elle a aimé le cadeau. Apparemment, il vaut la peine d’aller périodiquement à la librairie en ligne et de regarder de nouveaux articles. Peut-être que de cette façon, il sera possible d’améliorer légèrement la relation avec Alice."
    ...
    new "Je suis allé voir ma mère pour savoir ce qu’elle regardait, et l’autre jour, une amie lui a conseillé de regarder un film... Elle a dû penser que ma mère allait le regarder seule et donc elle n’a pas dit que ce film... avec un contenu érotique... Et plus nous le regardions, plus ma mère essayait de me faire partir. Mais le film est bon! J’adorerais regarder autre chose avec ma mère... En attendant, juste lui tenir compagnie ce sera bien."

    # game/core/09_opportunities.rpy:4
    old "Неплохо бы почаще составлять маме компанию за просмотром ТВ..."
    new "Ce serait bien de tenir compagnie à ma mère qui regarde la télévision plus souvent..."
    ...
    new "Oui. Maman regarde toujours la télévision après avoir pris un bain. Assis si sexy et mouillée dans une serviette ... Je l’ai vue bon gré mal gré! Et que se passe-t-il quand je commence à penser à ce qui se cache sous cette serviette... Mes jeans peuvent se déchirer... Mais c’est bien qu’ils cachent parfaitement ce qui rendrait maman inquiète. Pendant que je porte ces vêtements, je n'ai pas à m'inquiéter."

    # game/core/09_opportunities.rpy:4
    old "Мне стоит и дальше смотреть вместе с мамой ТВ. Это нас только больше сблизит..."
    new "Je devrais continuer à regarder la télévision avec ma mère. Ça ne fera que nous rapprocher..."
    ...
    new "C’est cool de regarder la télévision à côté d’une femme comme ma mère. Comme elle est dans une serviette, les pensées deviennent folles! J’espère que ma chemise avec un short pourront cacher l’excitation que je ressens."
    ...
    new "Si ma mère remarque mon érection, alors regarder la télévision avec elle prendra définitivement fin. Par contre, ce serait bien de savoir si elle l'a remarquée..."
    ...
    new "Maman dans de telles poses se repose sur ce canapé; elle est sur le point de faire quelque chose de sexy et de chaud, mais hélas... Juste en pensant à voir quelque chose comme ça, je ne peux pas tenir ma queue dans ces shorts. Je n’avais qu’à me retourner! Et ce n’est pas une bonne idée..."
    ...
    new "Oups... Ma mère a remarqué mon érection. Que puis-je dire, c’est vraiment difficile de ne pas la remarquer. Mais je suis à blâmer... Ce qui m’a empêché de tirer sur mon maillot et de ne pas m’en plaindre. Il n’y a pas non plus de garanties, mais je peux essayer..."
    ...
    new "L’essentiel est de collecter le montant nécessaire pour ce maillot. Et après l’achat, je devrais savoir si ma mère remarquera mon érection si je regarde la télévision avec elle en t-shirt et short..."
    ...
    new "Euh... Maman a remarqué mon humeur exaltée. Si je ne pouvais pas la cacher même sous la chemise, alors c’est un problème et cette télé regardée avec ma mère, je ne ferais que gâcher notre relation. Alors que faire ? Aucune idée... Mais je devrais trouver quelque chose."

    # game/core/09_opportunities.rpy:4
    old "Возможно, решение этой проблемы придёт само собой. Потребуются успехи в возможности \"Талантливый массажист\"..."
    new "Peut-être que la solution à ce problème viendra d’elle-même. Il faut réussir dans 'l'opportunité' : 'Masseur talentueux', ce sera nécessaire..."

    # game/core/09_opportunities.rpy:4
    old "Возможно, решение этой проблемы придёт само собой. Потребуются успехи в возможности \"Шаловливые ножки\"..."
    new "Peut-être que la solution à ce problème viendra d’elle-même. Il faut réussir dans 'l'opportunité' : 'Pieds coquins'..."

    # game/core/09_opportunities.rpy:4
    old "Возможно, решение этой проблемы придёт само собой. Потребуются успехи в возможности \"Школьница\"..."
    new "Peut-être que la solution à ce problème viendra d’elle-même. Il faut réussir dans 'l'opportunité' : 'Collégienne'..."
    ...
    new "Pendant que je faisais un massage du cou et des épaules à Lisa, j’ai eu une excellente idée! Pourquoi ne pas résoudre mon problème avec l'érection lorsque ma mère et moi regardons la télévision ensemble, en lui offrant un massage? Ça vaut le coup d’essayer... Et elle sera contente, et j’aurais moins de problèmes. L’essentiel est que ma mère aime le massage!"
    ...
    new "Seulement d’abord, vous devez affiner vos compétences en massage sur Lisa afin que maman aime tout. Lisa a adoré le massage du cou et des épaules : [lisa.flags.m_shoulder] sur 5"

    # game/core/09_opportunities.rpy:4
    old "Теперь не важно, что на мне будет одето, когда мы с мамой будем смотреть ТВ. Главное предложить ей массаж..."
    new "Maintenant, peu importe ce que je porte quand ma mère et moi regardons la télévision. L’essentiel est de lui offrir un massage..."
    ...
    new "C’était une excellente idée! Maintenant, ma mère sait de quoi mes mains sont capables. Elle était satisfaite du massage et veut même que je continue à le faire. Cela ne me dérange pas de masser les épaules de ma mère de temps en temps et c’est une excellente occasion de cacher mon excitation à ses yeux. Ne pas m’approcher trop près de son dos, sinon elle sentira quelque chose de dur reposer sur elle."
    ...
    new "Ce serait aussi cool de donner un massage à ma mère et de regarder un film érotique en même temps. Mais il est préférable d’apprendre à faire ce massage automatiquement d'abord, car le film sera distrayant. Il faudra réussir dans 'l'opportunité' : 'Tante bien-aimée'..."
    ...
    new "Avant d’acheter un film érotique et de persuader votre mère de le regarder, vous devez vous rapprocher d’elle. Ses cours de yoga du matin sont parfaits pour cela..."

    # game/core/09_opportunities.rpy:4
    old "Самое время прикупить какой-нибудь эротический фильм и предложить маме его посмотреть..."
    new "Il est temps d’acheter un film érotique et de proposer à ma mère de le regarder..."
    ...
    new "Je devrais inviter ma mère à regarder ensemble le film que j’ai acheté. Je me demande ce qui va se passer quand elle se rendra compte qu’on regarde à nouveau un film érotique..."
    ...
    new "Affaire en cours! J’ai regardé un autre film érotique avec ma mère! C’est vrai, pas tout, mais presque une heure... Elle a été tellement excitée par ce film et ce massage qu’elle n’a même pas senti sa serviette qui glissait. Et ma position à ce stade était la meilleure pour profiter de ce petit strip-tease aléatoire de ma mère. Peut-être que la prochaine fois, elle ne gardera plus la serviette? Si, bien sûr, elle regarde ce film avec moi..."

    # game/core/09_opportunities.rpy:4
    old "Остаётся дождаться, когда мама будет смотреть ТВ одна и напомнить ей, что мы кое-что не досмотрели..."
    new "Reste à attendre que maman regarde la télé toute seule et lui rappeler que nous n'avons pas fini quelque chose..."
    ...
    new "Alors ma mère et moi avons regardé 'La couleur de la nuit'. J’admirais à nouveau ses seins nus et tout va bien. Elle commence peu à peu à comprendre que je suis déjà adulte et ne résiste plus à regarder de tels films avec moi. Par souci de décence, ma mère, bien sûr, m’a dit de ne plus acheter de film érotique aussi cru, mais c’était comme si j’allais lui obéir! \n\nLe plus offensant, c'est que nous pouvons trop rarement regarder la télévision avec maman."
    ...
    new "Alors ma mère et moi avons regardé 'La couleur de la nuit'. J’admirais à nouveau ses seins nus et tout va bien. Elle commence peu à peu à comprendre que je suis déjà adulte et ne résiste plus à regarder de tels films avec moi. Par souci de décence, ma mère, bien sûr, m’a dit de ne plus acheter de film érotique aussi cru, mais c’était comme si j’allais lui obéir! \n\nLe plus offensant, c'est que nous pouvons trop rarement regarder la télévision avec maman. Il faut d'abord se débarrasser d'Eric, puis acheter des films érotiques. Jusqu'à présent, seulement un massage de temps en temps..."
    ...
    new "Il semble que ma mère adore le massage du dos, ce qui signifie que je ne vais pas le faire et le faire parfaitement. Mais, si au moins parfois cela fonctionne, alors c'est déjà bien. \nEh bien, une fois que je suis arrivé au dos de ma mère, puis à son cul aussi, vous devez obtenir, mais déjà à travers l'aide avec le yoga. Là-bas, il sera plus naturel de la soutenir pour le cul. \net quand maman s'habitue à tout cela, vous pouvez essayer de la persuader de continuer les leçons de fellation qu'elle a partagées avec Eric. Après tout, comment se réjouir d'une fellation a été montré, et comment faire plaisir aux femmes - non!"
    ...
    new "Il reste à voir si la réaction de maman à ma trique a changé. Mieux vaut être torse nu..."
    ...
    new "Après toutes ces leçons intimes de maman dans le bain, elle est déjà beaucoup plus détendue à propos de mon excitation pendant le massage. Peut-être qu'à l'avenir, cela cessera de la déranger et qu'elle me laissera masser non seulement son dos et ses épaules, mais aussi ses seins."
    ...
    new "Après tous ces fantasmes nocturnes de maman, elle est déjà beaucoup plus détendue quant à mon excitation pendant le massage. Peut-être qu'à l'avenir, cela ne la dérangera plus du tout et qu'elle me laissera masser non seulement son dos et ses épaules, mais aussi ses seins."
    ...
    new "J'ai remarqué que Lisa portait tout le temps le même maillot de bain d'une pièce. Est-il également impossible d'obtenir un bon bronzage ? Elle le pense, mais il n'y a pas d'autre solution. Le reste a disparu avec d'autres choses pendant le déménagement. Peut-être qu'il y a quelque chose que je pourrais faire pour l'aider ?"

    # game/core/09_opportunities.rpy:4
    old "Стоит подождать, вдруг проблема разрешится сама собой..."
    new "Cela vaut la peine d’attendre, tout à coup le problème se résoudra de lui-même ..."
    ...
    new "Pendant le petit déjeuner, Lisa a laissé entendre à sa mère qu’elle devrait acheter un maillot de bain lors de ses courses, qui ne cache pas la moitié du corps et dans lequel elle pourrait bronzer ..."
    ...
    new "Il s’est avéré que lors des derniers achats, elle a oublié d’acheter à Lisa le maillot de bain qu’elle avait demandé. Maintenant, je devrais attendre le week-end prochain quand Eric emmènera tout le monde faire les courses. Mais cette fois, Eric lui-même lui a promis de lui donner ce maillot de bain. Peut-être le devancer?"
    ...
    new "J’ai réussi à économiser de l’argent et à acheter le même maillot de bain que Lisa voulait. Maintenant, l’essentiel est de le lui donner avant qu’Eric ne le fasse..."

    # game/core/09_opportunities.rpy:4
    old "Лучше торопиться и со всех ног бежать к Лизе..."
    new "Je ferais mieux de me dépêcher et courir aussi vite que possible pour voir Lisa..."
    ...
    new "Ah bon ! J’ai tellement économisé pour un maillot de bain pour Lisa, et Eric m’a quand même devancé... Naturellement. Il a assez d’argent, j'en ai pas assez... Leur relation semble s’être améliorée."
    ...
    new "Comme c’est bien que j’aie réussi à acheter un maillot de bain pour Lisa, et à le lui donner avant Eric! Lisa semble m’aimer ! Et Eric est en train de s’effondrer avec ses cadeaux, parce que j’ai déjà donné ce que ma petite sœur veut!"
    ...
    new "J’ai acheté un maillot de bain, mais je n’ai pas eu le temps de le donner... Eric était en avance sur moi ! Maintenant, si je donnais ce maillot de bain hengy, Lisa serait très reconnaissante envers moi pas envers lui... Et que dois-je faire avec ce maillot de bain maintenant?"

    # game/core/09_opportunities.rpy:4
    old "Тусовщица"
    new "Fille de la fête"
    ...
    new "Alice demande constamment à sa mère de lui acheter une robe de soirée pour aller dans les boîtes de nuit. Elle refusait régulièrement jusqu’à ce qu’Eric lui propose de lui acheter une robe lors des prochaines courses. Je dois me dépêcher si je veux le faire en premier!"
    ...
    new "J’ai réussi à économiser un montant décent et à acheter une robe pour Alice. Maintenant, je dois avoir le temps de la lui donner avant que quelqu’un d’autre ne le fasse..."

    # game/core/09_opportunities.rpy:4
    old "Лучше торопиться и со всех ног бежать к Алисе..."
    new "Il vaut mieux se dépêcher et courir vers Alice..."
    ...
    new "C'est ce que signifie la malchance ! J'ai longtemps économisé pour trouver une belle robe courte pour Alice et j'en ai même acheté une, mais Eric m'a devancé... Et le plus frustrant, c'est qu'il a acheté exactement la même, mais qu'il le lui a donné en premier. Maintenant j'ai une robe inutile..."
    ...
    new "Pour en savoir plus sur ce qu’Alice fait à l’extérieur de la maison, je dois améliorer ma relation avec Lisa. Les sœurs connaissent probablement les différents secrets intimes les unes des autres..."
    ...
    new "C'est ce que signifie la malchance ! J'ai économisé pour acheter une jolie robe courte pour Alice, mais Eric m'a devancé... Ce n'est pas une surprise. Il a beaucoup d'argent. Il peut se permettre de tels cadeaux... Alice semble avoir une bien meilleure attitude envers lui maintenant..."
    ...
    new "Oui, je l'ai fait ! Non seulement j'ai réussi à économiser pour une robe, mais j'ai aussi réussi à la donner avant qu'Eric ne fasse. Et il allait le faire. Avec son argent, ce n'est pas difficile... Alice me traite beaucoup mieux maintenant. Absolument ! Maintenant elle peut aller dans des boîtes de nuit..."
    ...
    new "Lisa m’a dit quelque chose d’intéressant en secret. Il s’avère qu’Alice ne sait pas boire. Ou plutôt, une goutte d’alcool la change! C’est pourquoi elle n’accepte aucune boisson alcoolisée. Mais peut-être puis-je trouver autre chose ?"

    # game/core/09_opportunities.rpy:4
    old "В магазине наверняка найдётся что-то, что мне поможет..."
    new "Il y a probablement quelque chose dans le magasin qui va m’aider..."
    ...
    new "Donc, j'ai une boîte de chocolats à la liqueur. À en juger par l'inscription sur la boîte, le parfum est subtil. Cela signifie qu'il y a une chance qu'Alice ne remarque pas l'alcool. Je me demande si c'est suffisant pour la pousser a ce lâcher... pour faire quelque chose d'imprudent ?"

    # game/core/09_opportunities.rpy:4
    old "Проверить, действительно ли Алиса теряет голову от алкоголя, лучше прямо перед тем, как она отправится в клуб..."
    new "Vérifiez si Alice perd vraiment la tête avec l’alcool, c’est mieux juste avant qu’elle n’aille au club..."
    ...
    new "Ça a marché. Et c'est en quelque sorte... trop inattendu. Il n'est pas d'usage d'en parler à qui que ce soit. Apparemment, une goutte d'alcool supplémentaire a fait perdre la tête à Alice et elle s'est soûlée dans une boîte de nuit. Espérons qu'elle ne s'en rappelle pas elle-même, sinon je ne vivrais pas..."

    # game/core/09_opportunities.rpy:4
    old "Интересно, если я не буду вести себя как озабоченный и скажу что-нибудь приятное, Алиса будет реагировать иначе..."
    new "Je me demande si je n'agis pas comme un excité et que si je dis quelque chose de gentil, Alice réagira-t-elle différemment..."
    ...
    new "J’ai particulièrement aimé la façon dont Alice avait honte de son comportement avec moi! Avec ces chocolats, un seul compliment a suffi à Alice pour commencer à me taquiner avec ses seins nus et géniaux... Je me demande si ça peut être dilué dans quelque chose de plus facile à donner?"
    ...
    new "Peut-être que si je persuade Alice de ne pas porter de culotte, alors elle ne les portera pas au club? Et si oui, alors après le club ça peut être chaud..."

    # game/core/09_opportunities.rpy:4
    old "Чтобы добиться большего с Алисой в ванной комнате, мне стоит помогать ей с её блогом. Возможно, это нас сблизит..."
    new "Pour en faire plus avec Alice dans la salle de bain, je devrais l'aider avec son blog. Peut-être cela nous rapprochera..."
    ...
    new "Sentir les douces mains d'Alice sur ma bite, c'est vraiment cool ! Comment je veux la pousser plus loin avec ça... Et comme, sous l'emprise de l'alcool, elle n'hésite pas à me branler, que se passe-t-il si je l'impressionne avec mes baisers ?"

    # game/core/09_opportunities.rpy:4
    old "Чтобы было, чем впечатлять, нужно хорошенько поучиться поцелуям..."
    new "Pour impressionner, il faut apprendre à bien embrasser..."
    ...
    new "Alice semble étonnée de la façon dont j'embrasse. Mais l'embrasser ne suffit pas, il faut que je me rapproche encore plus d'elle pour qu'elle ne pense même pas à m'arrêter quand je commencerai à la caresser de toutes sortes de façons pendant ces baisers !"

    # game/core/09_opportunities.rpy:4
    old "Нужно больше подарков для Алисы, а значит потребуются успехи в возможности \"Блог\"..."
    new "D'autres cadeaux sont nécessaires pour Alice, ce qui signifie qu'il faudra progresser dans 'l'opportunité' : 'Blog'..."

    # game/core/09_opportunities.rpy:4
    old "Теперь с Алисой можно вести себя посмелее..."
    new "Maintenant vous pouvez vous comporter plus courageusement avec Alice..."
    ...
    new "Ces jeux avec Alice dans la salle de bain sont déjà beaucoup plus intéressants... Si seulement elle se souvenait de ce qu'elle faisait, au moins un peu. En attendant, j'ai tout ce dont j'ai besoin pour parfaire mon expérience sexuelle sur Alice. Je dois juste me rappeler de lui donner un autre chocolat à la liqueur quand elle reviendra du club. L'endroit où je la croise, près du miroir ou dans la baignoire, dépend du temps que je passe avec tante Kira."
    ...
    new "Pour tirer le meilleur parti d’Alice, je dois m’approcher d’elle avec l’aide de chocolats à l’alcool. Il faut réussir dans 'l'opportunité' : 'Pieds coquins'..."
    ...
    new "Maintenant, je peux compter sur quelque chose de plus que ce qu’Alice fait avec sa langue après le club. L’essentiel est qu’il y ait assez de chocolats avec de la liqueur ..."
    ...
    new "Oh, Alice... Ce n’est pas ton jouet rose que tu suces... J'ai un truc plus sérieux dans mon caleçon. Ses lèvres avec tant de difficulté me couvrent et donnent un plaisir irréel! Je suis sûr qu’il y a encore beaucoup de divertissement devant moi, mais pour cela je dois développer ma relation avec Alice..."

    # game/core/09_opportunities.rpy:4
    old "Дым сигарет"
    new "Fumée de cigarette"
    ...
    new "Il s'est avéré qu'Alice était une fumeuse. Et elle essaie de le faire quand il n'y a personne à la maison. Cela peut être utilisé... Le dire à ma mère n'est pas une option, sinon Alice me fera la vie dur dans cette maison! Mais je pourrais faire en sorte qu'Alice laisse ma mère le découvrir par elle-même... Et peut-être que tout ça va arranger les choses avec Alice ? Une chose est sûre, je dois voir comment Alice va réagir si je ne la dénonce pas à ma mère."
    ...
    new "Maman a senti la fumée de cigarette, mais je n'ai pas donné Alice. Je crois que ma sœur l'a apprécié. C'est juste ce qui l'empêche de la piéger pour que ma mère ne l'apprenne pas de moi, mais comment aurait-elle trouvé quelque chose elle-même? Et je ne suis pas en affaires!\n\net mieux, essayez de diluer votre petite sœur pour quelque chose comme ça... Je pense qu'elle sera d'accord sur beaucoup de choses, si seulement elle n'a pas été fessée devant tout le monde! Bien sûr, dans des limites raisonnables."

    # game/core/09_opportunities.rpy:4
    old "Нужно поймать Алису, когда она курит..."
    new "Je dois attraper Alice quand elle fume..."
    ...
    new "Ce n’est pas aussi simple que je le pensais! Alice est sûre qu’elle pourra garder sa mauvaise habitude secrète de sa mère. Apparemment, je dois rafraîchir la mémoire d’Alice de comment ma mère gifle le cul du coupable. Et je peux lui rappeler ça maintenant!"

    # game/core/09_opportunities.rpy:4
    old "Лучше подложить сигареты в комнату Алисы на видное место прямо перед приходом мамы с работы..."
    new "Il vaut mieux mettre des cigarettes dans la chambre d’Alice dans un endroit bien en vue juste avant l’arrivée de maman du travail..."
    ...
    new "Alors le cul d’Alisina a rougis sous la main sévère de ma mère! Maintenant, son secret est révélé et elle ne va certainement plus mentir à sa mère... À moins, bien sûr, que je ne l’aide pas dans cette affaire. Il ne reste plus qu’à convaincre Alice que je peux être un bon allié... Mais pas pour rien."

    # game/core/09_opportunities.rpy:4
    old "Главное поймать её снова с сигаретой. Тогда и убедить будет куда проще..."
    new "L’essentiel est de l’attraper à nouveau avec une cigarette. Ensuite, il sera beaucoup plus facile de la convaincre ..."
    ...
    new "Eh bien, c’est fait. Maintenant, Alice est prête à exécuter mes petits mais lubriques caprices. Ce n’est pas difficile pour elle, mais je suis content. Oh, combien de situations intéressantes différentes avec Alice seront maintenant possible..."
    ...
    new "Alice m'a parlé de son blog et de son problème d'avoir perdu des choses lors du déménagement. Maintenant, elle n’a rien à montrer, rien à bloguer et, elle est triste. Elle semble accepter toute aide ou idées, même de ma part! Peut-être s’asseoir devant Internet, chercher une solution?"
    ...
    new "À la suite de la recherche d’informations sur Internet sur ce qu’Alice pouvait faire, j'ai réussi à trouver quelque chose. Les plus populaires étaient les blogs, où les présentateurs sont des filles. De plus, plus les tenues sont révélatrices et plus les seins sont gros, plus le spectacle est prisé. Avec ses seins, bien sûr, rien ne peut être fait, mais les tenues..."

    # game/core/09_opportunities.rpy:4
    old "Может быть, поговорить с ней об этом?"
    new "Peut-être lui en parler?"
    ...
    new "J’ai parlé à Alice de mes conclusions sur la popularité du blog et j’ai laissé entendre qu'elle pouvait faire de la publicité non seulement pour des crèmes et des vernis, mais aussi pour des sous-vêtements, par exemple. Mais elle ne va pas dandiner son cul devant la caméra, alors elle va se faire filmer sans savoir quand je vais mettre la caméra furtive dans sa chambre. Qui sait combien de choses intéressantes je pourrais voir..."

    # game/core/09_opportunities.rpy:4
    old "Всему своё время..."
    new "Chaque chose en son temps..."

    # game/core/09_opportunities.rpy:4
    old "Нужно будет последить через скрытую камеру за тем, как Алиса ведёт блог..."
    new "Je devrais suivre à travers la caméra cachée, comment Alice tient son blog..."
    ...
    new "J’ai parlé à Alice de mes conclusions sur la popularité du blog et j’ai laissé entendre qu'elle pourrait faire de la publicité non seulement pour des crèmes et des vernis, mais aussi pour des sous-vêtements, par exemple. Mais elle ne va pas se dandiner le cul devant la caméra... Et en vain, car elle le fait déjà sur ma caméra cachée, que j’ai mise dans sa chambre. Qui sait, peut-être que je pourrais voir quelque chose qui ne s’est pas encore produit..."
    ...
    new "J’ai décidé de proposer à nouveau à Alice l’idée de développer son blog - pour faire de la publicité pour les sous-vêtements. Étonnamment, elle a accepté! Cependant, maintenant j’ai besoin de trouver des sous-vêtements pour qu’elle intéresse son public et attire l’attention des annonceurs ..."

    # game/core/09_opportunities.rpy:4
    old "Стоит подарить Алисе красивое нижнее бельё. Дело плёвое, если есть деньги..."
    new "Cela vaut la peine de donner à Alice de beaux sous-vêtements. C’est un truc qui va cracher si j'ai de l’argent..."
    ...
    new "Acheter pour Alice quelque chose de plus sexy je n'en suis que plus heureux. Il me faut de l’argent... Tant pour les sous-vêtements que pour l’appareil photo..."

    # game/core/09_opportunities.rpy:4
    old "Купить для Алисы что-нибудь посексуальнее я только рад. Были бы деньги..."
    new "Acheter pour Alice quelque chose de plus sexy je n'en suis que plus heureux. Il me faut de l’argent..."

    # game/core/09_opportunities.rpy:4
    old "Самый лучший момент для дарения, когда Алиса ведёт свой блог в нижнем белье..."
    new "Le meilleur moment pour le donner, c’est quand Alice blogue en sous-vêtements..."
    ...
    new "J'ai choisi quelque chose de plus sexy pour Alice, à savoir un Body translucide. Modérément Franc, parce que sinon je risque de ne pas le voir sur elle. Et en donnant, alors qu'elle était impressionnée, j'ai aussi réussi à la persuader de poser pour moi... elle a besoin de photos de haute qualité pour le développement du blog! \n\nJe n'ai pas beaucoup tourné, après tout, Alice et Moi ne sommes pas si proches, mais nous trouvons déjà mieux un langage commun. Voyons ce qui se passe ensuite..."
    ...
    new "J'ai choisi quelque chose de plus sexy pour Alice, à savoir un Body translucide. Modérément Franc, parce que sinon je risque de ne pas le voir sur elle. Et en donnant, alors qu'elle était impressionnée, j'ai aussi réussi à la persuader de poser pour moi... elle a besoin de photos de haute qualité pour le développement du blog! \n\nla séance Photo est très intéressante, merci pour cela aux bonbons avec de l'alcool. J'ai réussi à prendre des photos très chaudes avec Alice et elles conviendront parfaitement à ma collection... Même si Alice et moi ne sommes toujours pas très proches, nous trouvons déjà mieux un langage commun. Voyons ce qui se passe ensuite..."
    ...
    new "Seulement ma relation avec Alice a commencé à s'améliorer petit à petit, comme Eric m'a laissé tomber avec des questions sur ce que ma sœur aînée faisait à l'ordinateur... \n\nje lui ai dit tout ce que je savais sur son blog. Eh bien, sinon, nous sommes amis. Maintenant, il va l'aider avec le développement du blog et je ferais mieux de ne pas interférer avec cela... mieux encore, l'aider avec ça."
    ...
    new "Seulement ma relation avec Alice a commencé à s'améliorer petit à petit, comme Eric m'a laissé tomber avec des questions sur ce que ma sœur aînée faisait à l'ordinateur... \n\nj'ai décidé de ne pas lui faciliter la vie et j'ai dit que je n'en savais pas grand-chose. Eric, pour ne pas perdre son temps, m'a demandé d'en apprendre autant sur les cours d'Alice en quelques semaines..."
    ...
    new "Seulement ma relation avec Alice a commencé à s'améliorer petit à petit, comme Eric m'a laissé tomber avec des questions sur ce que ma sœur aînée faisait à l'ordinateur... \n\nj'ai décidé de mettre fin à la querelle avec Eric et je lui ai dit tout ce que je savais sur son blog. Maintenant, il va l'aider avec le développement du blog et je ferais mieux de ne pas interférer avec cela... mieux encore, l'aider avec ça."
    ...
    new "Seulement ma relation avec Alice a commencé à s'améliorer petit à petit, comme Eric m'a laissé tomber avec des questions sur ce que ma sœur aînée faisait à l'ordinateur... \n\nje n'ai absolument aucune envie de l'aider à rouler avec ma petite soeur, ce que je lui ai dit. Nous avons une querelle! La chose principale est que je ne peux pas faire ça de côté..."
    ...
    new "Maintenant, tous les mercredis, pendant que maman prend un bain, Eric traîne chez Alice dans la pièce, l'aidant soi-disant avec un blog. Il est clair qu'il veut vraiment regarder Alice en sous-vêtements... et dans le futur et dans sa culotte pour monter.\n\net j'ai eu la chance d'apprendre qu'Eric allait lui acheter un nouveau Body en dentelle! C'est dommage, bien sûr, qu'elle ne me l'ait pas demandé. Je me demande comment Eric va réagir si je le devance avec l'achat..."
    ...
    new "Si je veux faire ça, je dois me dépêcher pour avoir le temps de lui donner le body avant samedi... Et il faut le donner, quand Alice est avec son blog, alors elle peut se déshabillée devant moi !"

    # game/core/09_opportunities.rpy:4
    old "Что бы я там не хотел, теперь уже поздно! Мне остаётся только наблюдать..."
    new "Quoi que je veuille, il est trop tard maintenant! Tout ce que j’ai à faire est d’observer..."

    # game/core/09_opportunities.rpy:4
    old "Надо хоть подсмотреть, как это сексуальное боди смотрится на Алисе..."
    new "Je devrais au moins regarder à quoi ressemble ce body sexy sur Alice..."
    ...
    new "Eric a donné à Alice le body en dentelle qu’elle avait demandé. Il semble que cela les ait rapprochés, ce qu’il voulait, mais je n’ai pas eu le temps de le devancer. Je dois me débarrasser d’Eric au plus tôt, sinon il me prendra tout..."
    ...
    new "Eric a donné à Alice le body en dentelle qu’elle avait demandé. Il semble que cela les ait rapprochés, ce qu’il voulait. Et continuera à se rapprocher d'elle ..."
    ...
    new "J’ai réussi à devancer Eric avec l’achat du body en dentelle et à le donner à Alice en premier! Elle a même changé de vêtements devant moi et ne s’est pas trop couverte. Certes, à la fin, sa jambe a été couverte, mais cela signifie que j’ai maintenant une bonne raison d’aller un peu plus loin dans le massage de ses belles jambes qu’avant... Et je devrais essayer!"
    ...
    new "Eric s'est avéré, pour le moins, pas ravi que je l'ai devancé avec le don d'un Body en dentelle pour Alice.\n\nIl m'a prévenu que si je me trompais une fois de plus, nous ne serions plus amis... Et en guise de punition, il m'a privé de toutes les \"primes\" possibles, que j'ai maintenant besoin de corriger d'une manière ou d'une autre..."

    # game/core/09_opportunities.rpy:4
    old "Эрик оказался, мягко говоря, не в восторге от того, что я опередил его с дарением кружевного боди для Алисы.\n\nОн пригрозил, что у меня теперь будут большие проблемы! Как будто меня этим можно испугать..."
    new "Eric s'est avéré, pour le moins, pas ravi que je l'ai devancé avec le don d'un Body en dentelle pour Alice.\n\nIl a menacé d'avoir de gros problèmes maintenant! C'est comme si ça pouvait me faire peur..."
    ...
    new "Au cas où, vous feriez mieux d'économiser un peu d'argent, au moins 1500 $, car on ne sait pas vraiment ce qu'Alice voudra acheter..."
    ...
    new "Il semble qu'Alice ait un désir ardent de diffuser sa façon de jouer aux jeux vidéo et, ce faisant, elle s'habille de façon sexy pour correspondre au thème du jeu. Et j'adorerais y participer. Nous avons décidé de commencer avec le costume de Chat Noir de l'univers Spider-Man, mais Alice veut compléter le look avec d'autres accessoires. Je vais donc prendre une photo d'elle... Je veux dire, prendre des photos."
    ...
    new "Moi, sans grand espoir, j’ai suggéré à Alice de l’enduire de crème solaire... Ce que ni elle ni moi n’avions fait. Mais, ça ne la dérange pas! J’ai déjà hâte de frotter cette crème sur son corps... Seulement, il faut d’abord l’acheter. Ainsi que des vêtements plus légers, car il fera chaud dans la cour!"
    ...
    new "Maintenant, j’ai tout pour donner à Alice un bronzage uniforme et sûr. Ne serait-ce que pour tout gâcher de mes propres mains... J’espère qu’elles ne sont pas trop maladroites. Quoi qu’il en soit, je vais le savoir bientôt."

    # game/core/09_opportunities.rpy:4
    old "Нужно хотя бы несколько раз намазать Алису кремом, прежде чем станет что-нибудь понятно..."
    new "Vous devez au moins quelques fois enduire Alice de crème avant que tout ne devienne facile..."
    ...
    new "Et je suis génial ! Alice a dit que je n’étais pas doué et a lancé l’idée d’apprendre le massage. Pourquoi pas? Ce n’est peut-être pas si compliqué. Sûrement sur Internet, je peux trouver des cours de base sur le massage, mais les cours de formation coûteront de l’argent."
    ...
    new "Il vaut la peine d’acheter au moins une leçon sur le massage, afin qu’il y ait quelque chose à montrer à Alice de nouveau. Et à l’avenir, plus j’apprends, plus le succès que j’atteindrais sera grand..."
    ...
    new "Est-ce que j'imagine ou est-ce qu’Alice aime vraiment quand je commence le massage avec ses pieds? Surtout avec les pieds. C’est peut-être son point faible? Si c’est le cas, sa faiblesse sera à mon avantage !"
    ...
    new "Il serait bon de commencer le massage, à chaque fois, avec ses belles jambes. Regarder ça et partout où je peux masser à la fois. Ou peut-être que je vais la persuader d’enlever le haut du maillot de bain sans aucun problème..."
    ...
    new "Magnifique! Je peux donc devenir masseur professionnel! Et ça ne me dérangerais pas... L’essentiel est que j’ai plus de clients de l'autre sexe! Mais les cours en ligne seuls sont insuffisants, j'ai besoin d’une pratique et d’une formation à part entière. Et vont-ils m’emmener quelque part pour étudier cela sans aller à l’école? Peut-être que tante Kira m'aidera avec ça d’une manière ou d’une autre?"
    ...
    new "Je vais devoir démontrer à tante Kira mes compétences en massage. Et cela nécessitera le succès dans 'l'opportunité' : 'Tante bien-aimée'..."
    ...
    new "Bonne nouvelle! Tante Kira a dit qu’elle rencontrerait sa camarade de classe, qui est engagée dans le massage, et peut-être qu’elle m’emmènerait à sa formation. J’espère que ce sera le cas, car là-bas, j’apprendrai encore plus qu’ici. J’ai hâte d’y être..."
    ...
    new "C’est dommage que je doive persuader Alice de masser ses pieds, mais que puis-je faire... Peut-être qu’un jour cela changera, qui sait. Mais, pour que je puisse pratiquer encore plus en massage, et en même temps apprendre comment et ce que ma sœur aime le plus. Et les chances sont très bonnes avec Alice de faire plus."

    # game/core/09_opportunities.rpy:4
    old "Если Алисе будет нравиться массаж, то можно попробовать стащить с неё джинсы. Вернее, уговорить, чтобы она их сняла..."
    new "Si Alice aime un massage, vous pouvez essayer d'enlever son jean. Ou plutôt, de la persuader de les enlever..."
    ...
    new "Ce serait bien de se rapprocher davantage de ses sœurs. Ensuite, nos cours communs avec eux deviendront plus naturels et prometteurs. \navec Alice, une attention particulière devrait être accordée aux succès dans la possibilité de \"Fêtard\"..."
    ...
    new "Mais les chocolats à l’alcool font leur travail et très rapidement ! Alice devient clairement plus malléable et ouverte dans mes mains. Sa culotte se cache si peu que je me lève un peu à chaque fois. Je sens que tôt ou tard ses jambes reposeront sur moi et qu’il y aura beaucoup de cris! Et comme c’est merveilleux qu’elle ne s’en souvienne pas plus tard."
    ...
    new "Alice est une méchante! Cela semble être une garce, mais en fait, un seul bonbon suffit pour que ses jambes espiègles commencent à me branler la bite. Que dire de deux bonbons... \nOh, comme c'est agréable et cool! Bien sûr, sans massage, cela ne serait pas arrivé, car ses jambes sont une zone érogène solide. Dommage qu'elle ne s'en souvienne pas... Ou peut-être bien. \nDans tous les cas, pour obtenir plus d'elle dans un massage avec des bonbons, vous devez vous rapprocher d'elle sans eux... Et combien de temps faut-il pour qu'elle s'éloigne des bonbons?"
    ...
    new "Il vaut la peine de suivre Alice à travers les caméras cachées. Qui sait ce qu’elle peut encore faire pendant qu’elle se détends, après le travail des pieds, avant d’aller au lit ..."
    ...
    new "Euh... Et ma sœur manie habilement son jouet rose! Est-ce mon massage qui l’a fait si bien se lâcher? C’est comme ça. Et les chocolats l’ont juste mise en appétit et elle en veut plus... Cela ne signifie-t-il pas que je peux aller beaucoup plus loin en massant ses jambes ?"

    # game/core/09_opportunities.rpy:4
    old "Пора покорять новые вершины в массаже ног Алисы у ТВ..."
    new "Il est temps d'explorer de nouveaux horizons dans le massage des pieds d’Alice devant la télé..."
    ...
    new "Oui, oui... Cela ne la dérangeait vraiment pas que mes mains bougent vers plus haut... Même si les vêtements séparent mes doigts d’Alice, je la sens toujours et elle est géniale! Certes, sans deux chocolats, cela ne peut pas être possible, ce qui signifie que je devrais me rapprocher encore plus d’Alice ... Et peut-être que je peux même mettre mes doigts dans le saint des saints!"

    # game/core/09_opportunities.rpy:4
    old "Нужно больше сближаться с Алисой в экстремальных ситуациях. Для этого потребуются успехи в возможности \"Арахнофобия\"..."
    new "Je dois me rapprocher d’Alice dans des situations extrêmes. Cela nécessitera des progrès dans 'l'opportunité' : 'Arachnophobie'..."

    # game/core/09_opportunities.rpy:4
    old "Стоит попробовать не торопиться довести Алису до оргазма в самый последний момент..."
    new "Il vaut peut-être la peine d’essayer de ne pas se presser et d’amener Alice à l’orgasme au tout dernier moment ..."
    ...
    new "C’est mieux! Si je prends mon temps, Alice me laisse même enlever ses vêtements, si seulement je ne m’arrêtais pas et que je continuais à la caresser. Et il semblerait que tout soit génial, mais avec l’aide de chocolat, je ne pourrai pas aller loin avec Alice, car elle ne se souviendra de rien ... Elle ne réagit plus aussi brusquement à mes érections, alors pourrais-je essayer de me coller entre ses jambes lorsqu’elle est massée devant la télévision, sans les chocolats?"
    ...
    new "Cela vaut la peine de tenter ma chance pendant le massage des pieds d’Alice devant la télé sans chocolat, je vais essayé de sortir ma bite et regarder sa réaction..."
    ...
    new "Mais cela s’est avéré beaucoup mieux que je ne le pensais. Je m’attendais à un passage à tabac brutal de la part d’Alice, mais elle a réagi relativement calmement à ce que je faisais. Oui, j’étais un peu excité, mais elle aimait ça... jusqu’à ce qu’elle se rende compte qu’elle me caressait avec ses pieds. Cela devra certainement être répété..."

    # game/core/09_opportunities.rpy:4
    old "Стоит снова рискнуть. Хуже не будет..."
    new "Cela vaut à nouveau le risque. Ça ne va pas empirer..."
    ...
    new "Alice ne s’attendait pas à ce que je fasse la même chose que la dernière fois, ou elle a attendait ça et s’est juste levée pour ne pas sembler aussi perverse que moi! Dans tous les cas, maintenant elle n’est pas contre un tel massage, mais seulement si elle n'est pas trop chatouilleuse. Je vais essayer de le faire..."
    ...
    new "Tout semble génial! Nous avons finalement convenu que nous l’aimions tous les deux. Je pense que oui, je peux même essayer de masser ses jambes au-dessus des genoux, mais encore plus haut, il vaut mieux ne pas encore grimper vers sa chatte, après tout, Alice est prude... Mais je pense que cela changera lorsque je pratiquerais le massage comme un professionnel!"
    ...
    new "Maintenant, après ce que j’ai réalisé sans chocolats, aura-t-il moins de fun qu’avant? Du moins pour ce qui a déjà été fait. Mais pour quelque chose de nouveau, sans deux chocolats je ne peux tout simplement rien faire ..."
    ...
    new "Maintenant, Alice considère qu’il est de son devoir de me caresser non seulement avec des pieds coquins pour un massage, mais aussi d’utiliser sa bouche tout aussi coquine! Je ne veux pas risquer de planter mon sexe plus profondément dans sa bouche si possible, mais quand notre relation sera encore meilleure, sa respiration sifflante... Attends, ma sœur... Ce ne sera pas facile pour toi!"
    ...
    new "Lisa ne semble rien savoir du tout sur les garçons. Peut-être n’en avait-elle même jamais vu, car elle était si surprise par mon réveil inhabituel. Peut-être devrais-je faire des activités éducatives avec ma sœur cadette? Mais par où commencer ?"

    # game/core/09_opportunities.rpy:4
    old "Для начала, нужно поговорить об этом с Лизой..."
    new "Tout d’abord, je dois en parler à Lisa..."
    ...
    new "J’ai parlé à Lisa et il est devenu clair que pour lui enseigner quelque chose, il faut d’abord gagner sa confiance. Pour que je ne sois pas considérée comme un pervers et que mes érections deviennent quelque chose de naturel pour Lisa... et même une curiosité pour elle... Et cela prend du temps. La laisser s’y habituer."

    # game/core/09_opportunities.rpy:4
    old "Не стоит просыпаться раньше Лизы, иначе она не привыкнет к моему \"приподнятому\" состоянию..."
    new "Je ne dois pas me réveiller avant Lisa, sinon elle ne s’habituera pas à mon état 'dur' le matin..."
    ...
    new "Lisa a revu mon sexe dur tôt le matin. Cette fois, elle n’a pas appelé sa mère, ce qui est bien. Bien qu’elle m’ait regardé non seulement avec suspicion, mais aussi avec intérêt. C’est du moins ce que je pensais. Je pense qu’il faut lui en parler..."

    # game/core/09_opportunities.rpy:4
    old "Чем раньше поговорю с ней об этом, тем лучше..."
    new "Plus tôt je lui en parlerais, mieux ce sera..."
    ...
    new "Ce n’est certainement pas exact, mais il me semble que Lisa voulait me toucher pendant que je dormais. Et à en juger par sa réaction au fait que je l’ai vue, elle a été surprise par elle-même. On verra ce qu’elle a à dire à ce sujet..."
    ...
    new "Il semble que l’intérêt de Lisa pour le sexe opposé et tout ce qui concerne l’âge adulte augmente à pas de géant. Je ne sais pas si j’étais si en colère contre elle le matin ou quelque chose comme ça, mais elle a accepté de m’écouter sur les garçons et tous ces trucs d'adultes ... C’est juste avant de lui enseigner, peut-être devrais-je apprendre quelque chose moi-même? Et surtout - en même temps, pour ne rien gâcher, sinon elle refusera à nouveau ..."
    ...
    new "Cela vaut la peine de se rapprocher de Lisa pour qu’elle me fasse confiance et je vais lui apprendre davantage. Il faudra réussir dans 'l'opportunité' : 'Collégienne'..."
    ...
    new "Alors, Lisa m’a demandé ce que j’allais lui apprendre. Et m’a immédiatement mis dans une situation stupide. Je dois lui apprendre, mais je ne peux pas l’embrasser moi-même je ne sais pas le faire! J’ai un besoin urgent de trouver quelqu’un pour m’aider pour cela... Ouais, c’est facile à dire..."

    # game/core/09_opportunities.rpy:4
    old "Стоит поговорить об этом с Алисой и мамой. Сомневаюсь, что они мне чем-то помогут, но попытка - не пытка..."
    new "Cela vaut la peine d’en parler à Alice et à ma mère. Je doute qu’elles m’aident de quelque manière que ce soit, mais de le faire n’est pas une torture..."
    ...
    new "Il y a encore un peu d’espoir pour tante Kira. Mais je ne dois pas aller immédiatement vers elle avec des questions sur les baisers. Il faudra réussir dans 'l'opportunité' : 'Tante bien-aimée'..."
    ...
    new "Tante Kira reste un peu debout, après son retour du travail, tard dans la nuit, mercredi et dimanche. Je dois essayer de rattraper mon retard avec elle avant qu’elle se couche..."
    ...
    new "Tante Kira est une excellente enseignante pour embrasser! C’était très cool! Mais je suis encore loin de son niveau. Elle a accepté de m’apprendre, ce qui est une bonne chose. Donc, je ne suis pas si mauvais, ou tante Kira ne voulait tout simplement pas m’offenser. Qui sait, peut-être qu’elle m'apprendra autre chose ?"
    ...
    new "Eh bien, je peux dire que les bases que j’ai apprises, c’était très chaud! En embrassant tante Kira, j’ai touché beaucoup de choses qui sont très excitantes et belles... Maintenant, je dois continuer à m'entraîner à embrasser avec elle et transmettre les connaissances acquises à Lisa... Et il est préférable de lui apprendre cela quand elle est la plus détendue et dans notre chambre avec elle. Mais elle a encore besoin d’être convaincue..."
    ...
    new "Il vaut mieux que Lisa soit de bonne humeur, sinon il est peu probable qu’elle accepte de m’embrasser. Le moment parfait, c’est quand elle lit..."
    ...
    new "J’ai parlé à Lisa de sa formation. Elle a proposé un certain nombre de conditions, y compris l’interdiction pour moi de la toucher si elle est contre. Eh bien... Bien sûr, il est difficile de résister à laisser trainer mes mains sur son corps pendant un baiser... Mais si je m’embrasse bien, peut-être qu’elle ne se souciera plus que je la touche. Et il ne faut pas oublier de ne pas gâcher la bonne humeur de Lisa."
    ...
    new "Pour impressionner Lisa avec mes baisers, il est important de continuer les leçons avec tante Kira. Baisers réussis avec Lisa : [lisa.flags.kiss_lesson] de 3"
    ...
    new "J’arrive à impressionner Lisa par mon art d’embrasser ! Bien que, alors que cet art ne m'aide pas plus, mais au moins, elle aime! Après tout, tante Kira est une excellente enseignante. Mais je dois continuer à pratiquer avec Kira et Lisa. Au fait, je peux diversifier mes leçons de baiser avec Lisa... Par exemple, organiser une leçon après un massage réussi de ses mains."
    ...
    new "Embrasser Lisa après un massage des mains réussi n’est possible que si ce jour-là, avant cela, il n’y avait pas de leçons de baiser. Baisers réussis avec Lisa : [lisa.flags.kiss_lesson] sur 6"
    ...
    new "Lisa a laissé entendre que cela ne la dérangeait pas de passer à autre chose et j’ai décidé de la captiver avec des baisers tellement qu’elle aimait mon toucher. Et pour cela, je dois m'entrainer plus à embrasser avec tante Kira la nuit ..."
    ...
    new "Plus de pratique dans les baisers avec Kira et je ne dois pas oublier l’humeur de Lisa. Baisers réussis en touchant Lisa: [lisa.flags.kiss_touch] de 3"
    ...
    new "Lisa aime vraiment la façon dont je m’embrasse. Elle a même laissé entendre qu’il était temps de lui apprendre autre chose d’utile. Cette fois, je pense, cela vaut la peine de resserrer la théorie. Peut-être lui acheter une sorte de livre sur l’anatomie afin qu’elle comprenne la physiologie et comprenne quels processus naturels peuvent se produire entre les hommes et les femmes?"
    ...
    new "Je dois regarder quelque chose comme ça dans la boutique en ligne. Et après avoir acheté ça, il ne fait pas de mal de le lire moi-même. Bien que, ce n’est pas nécessaire, je peux immédiatement le donner à Lisa ..."
    ...
    new "J’ai décidé qu’il serait utile pour moi de lire le livre que j’ai acheté pour Lisa. Je vais peut-être découvrir quelque chose d’intéressant pour moi-même..."

    # game/core/09_opportunities.rpy:4
    old "Нужно набраться терпения и прочитать эту книгу..."
    new "Il faut être patient et lire ce livre..."
    ...
    new "Le livre est lu ! Ce n’est pas que j’ai découvert beaucoup de nouvelles choses, mais il y a quelque chose qui peut aider Lisa et moi à nous rapprocher encore plus. En attendant, je peux lui donner le livre..."

    # game/core/09_opportunities.rpy:4
    old "Подарить можно в любое время, когда Лиза не особо занята..."
    new "Je peux le donner à tout moment, lorsque Lisa n’est pas particulièrement occupée..."
    ...
    new "J’ai donné à Lisa un livre qui contient de nombreuses réponses à ses questions. Je vais devoir lui demander au bout d’un moment ce qu’elle pense de ce livre..."
    ...
    new "Seulement j'ai donné à Lisa un livre sur l'éducation sexuelle, comme Eric l'a dessiné. Il, vous voyez, avec ma mère, va s'occuper de son éducation sexuelle! \n\nEn échange de la possibilité d'espionner ce processus et d'un bonus avec lequel je devrais décider du temps, j'ai accepté de le soutenir. On est \"amis\" avec lui."
    ...
    new "Seulement j'ai donné à Lisa un livre sur l'éducation sexuelle, comme Eric l'a dessiné. Il, vous voyez, avec ma mère, va s'occuper de son éducation sexuelle! \n\nMalgré le fait que nous sommes \"amis\", j'ai essayé de le convaincre que Lisa était encore trop tôt pour le savoir... Ça n'a pas beaucoup aidé, mais Eric m'a donné quelques semaines pour \"lire des livres sur l'éducation sexuelle\" avec Lisa. Au moins, j'ai gagné un peu de temps qui vaut la peine d'être utilisé à bon escient..."
    ...
    new "Seulement j'ai donné à Lisa un livre sur l'éducation sexuelle, comme Eric l'a dessiné. Il, vous voyez, avec ma mère, va s'occuper de son éducation sexuelle! \n\nj'ai naturellement refusé de l'aider. Inimitié, donc inimitié! Il est peu probable que maintenant j'ai beaucoup de temps pour m'en débarrasser, donc il faut plutôt chercher un tel moyen..."
    ...
    new "Il s’est avéré qu’Eric payerait un tuteur pour Lisa le dimanche pour améliorer ses notes, mais en fait, c'est pour gagner sa confiance. Maintenant, j’ai un peu de temps avant qu’Eric ne commence à draguer Lisa."
    ...
    new "Lisa m'a demandé conseil, car il s'est avéré qu'après la fin de leurs cours théoriques, Eric lui a proposé de mettre tout cela en pratique sans la participation de ma mère. Heureusement, Lisa m'écoute et j'ai réussi à la convaincre qu'il vaut mieux ne pas être d'accord. \nmais il est peu probable qu'Eric s'en réjouisse. J'ai sûrement des problèmes à cause de ça, mais que peut-on faire?.. \nCe serait bien de réduire un peu son activité dans notre maison! \nSi je pouvais mettre quelque chose comme un laxatif ou un sédatif dans la nourriture d'Eric, il est possible que ce soit la Dernière chose à laquelle il penserait. \n\nl'Essentiel est d'organiser de telles saletés pas plus d'une fois par semaine, sinon il comprendra tout."
    ...
    new "De toute évidence, Lisa est amoureuse d'un de ses camarades de classe nommé Alex. Comme elle l'a dit, il a une amie Olivia, la plus belle fille de l'école. Lisa attend de moi de l'aide sous forme de conseils - comment elle va continuer.\n\net c'est une bonne question! D'une part, je veux l'aider avec des conseils d'affaires, et d'autre part, je ne veux pas donner une petite soeur dans les mains d'un certain Alex. Vous devez prendre votre temps et réfléchir à tout cela pendant un certain temps."

    # game/core/09_opportunities.rpy:4
    old "Да, и похоже о своём мальчике Лиза разговаривает только, когда у неё хорошее настроение..."
    new "Oh, et on dirait que Lisa ne parle de son copain que lorsqu’elle est de bonne humeur..."

    # game/core/09_opportunities.rpy:4
    old "Может, за недельку или чуть больше в голову придёт какой-нибудь стоящий совет для Лизы..."
    new "Peut-être que dans une semaine ou un peu plus, des conseils valables pour Lisa me viendront à l’esprit..."
    ...
    new "Après avoir bien réfléchi au conseil à donner à Lisa au sujet d'Alex, j'ai décidé d'être sournois et lui ai suggéré de devenir amie avec Olivia. Ainsi, Lisa pourra savoir si Alex est vraiment aussi bon qu'elle le pense. Il n'est sûrement pas trop parfait... Ou peut-être même pire... Je ne sais pas combien de temps il faudra à Lisa pour devenir une amie discrète d'Olivia. Je devrais peut-être m'intéresser à ses progrès de temps en temps..."

    # game/core/09_opportunities.rpy:4
    old "Думаю, через 5-7 дней у Лизы можно будет что-нибудь узнать..."
    new "Je pense que dans 5-7 jours, Lisa sera capable d’apprendre quelque chose..."
    ...
    new "Lisa essaie de comprendre comment être amie avec Olivia, la petite amie d’Alex. Pour ce faire, Lisa va essayer d'être amie avec quelqu’un d’autre qui aime encore Olivia, pour lui demander plus d’informations sur cette fille... Je vais attendre un peu et découvrir ce que Lisa peut apprendre."
    ...
    new "Lisa a réussi à découvrir une chose curieuse sur Olivia : elle ne porte pas de sous-vêtements ! Bien sûr, ce n'est pas grand-chose, mais cela pourrait s'avérer un bon sujet de discussion... Elle doit apprendre à la connaitre, et puis elles deviendront amies..."
    ...
    new "Enfin quelque chose qui commence à fonctionner ! Lisa a réussi à découvrir qu'Olivia ne porte pas de culottes parce qu'elle vient d'une sorte de famille nudiste ou naturiste, peu importe. Et elle aime aussi les piscines, mais pour une raison quelconque, il n'y en a pas chez eux. Maintenant, c'est juste une question d'un peu de... Que Lisa invite Olivia à nous rendre visite, où elles prendront le soleil et nageront. Et, bien sûr, la socialisation en dehors de l'école, qui, je pense, les rapprochera..."
    ...
    new "Comme si tout s’était bien passé avec Alex, Lisa n’a pas marché dans son jeu, mais c’est une bonne occasion de se rapprocher de ma sœur cadette, l’aidant à en apprendre davantage sur l’âge adulte. Il faudra réussir dans 'l'opportunité' : 'Mentor'..."
    ...
    new "Grâce à mon mentorat, Lisa est bien consciente de ce que les garçons pensent et de ce qu’ils veulent. Espérons que cette connaissance la protégera d’Alex. Maintenant, il suffit d’attendre un peu et de savoir si Lisa a appelé Olivia pour nous rendre visite..."
    ...
    new "J’ai rencontré Olivia ! Oui, la réalité a même légèrement dépassé toutes mes attentes! Olivia n’a absolument pas honte de sa nudité... Ce à quoi j’ai réagi en conséquence. Eh bien, l’essentiel est que j’ai fait une bonne impression ..."
    ...
    new "Il ne sera pas superflu de parler avec Olivia pendant que elle et Lisa prennent un bain de soleil. Être conscient de ce qu’elle vit et comment elle et Lisa s'entendent..."
    ...
    new "J'ai réussi à avoir une petite discussion avec Olivia. Elle s'est avérée ne pas être aussi stupide que je le pensais. Elle aime s'amuser, est joyeuse, à la langue bien pendue... Oh, j'aimerais pouvoir l'essayer... Mais j'ai été détourné du sujet. D'après ce que j'ai compris, sa relation avec Alex n'est pas idéale. La seule question est de savoir qui est le plus à blâmer, elle ou lui ? Je pense qu'avec le temps, Lisa et moi pourrons en savoir plus sur eux. Entre-temps, je peux, au moins une fois par semaine, regarder les seins nus d'Olivia dans notre cour sans embâter pour ça!"

    # game/core/09_opportunities.rpy:4
    old "Нужно продолжать общаться с Оливией, когда она бывает у нас в гостях по средам..."
    new "Je dois continuer à parler avec Olivia lorsqu’elle nous rend visite le mercredi..."
    ...
    new "Olivia et moi avons eu une petite discussion à propos de Lisa. Même si ce n'est pas très joli, nous sommes arrivés à la conclusion que nous devons travailler sur l'émancipation sexuelle de ma petite sœur. Au moins un peu... Et Olivia est parfaite pour cela ! C'est une fille sans complexes, très ouverte d'esprit à tous points de vue. Et comme le dit le proverbe, on obtient ce que l'on peut de qui l'on peut !"

    # game/core/09_opportunities.rpy:4
    old "Нужно продолжать общаться с Оливией, когда она бывает у нас в гостях. Теперь по вторникам и пятницам..."
    new "Je dois continuer à parler avec Olivia lorsqu’elle nous rend visite. Maintenant, les mardis et vendredis..."
    ...
    new "Olivia a découvert que le vendredi soir, notre maison était vide et Lisa et moi étions seules pendant un moment... Un bon moment pour nous trois d’aller voir le grand écran dans le salon! Et le plus cool, c’est que je n’ai aucune idée de ce qui va se passer! Mais ce dont je suis sûr, c’est que ça va être intéressant..."
    ...
    new "Olivia est arrivée à minuit comme promis. Bien que j’aie deviné sous quelle forme nos rassemblements nocturnes étaient prévus, mais je doutais toujours si je serais vraiment si chanceux ... Et Olivia ne m’a pas déçu ! Elle a immédiatement enlevé ses vêtements..."
    ...
    new "Ugh... Quel bonheur d'être sur le même canapé que des filles aussi adorables ! Olivia est complètement nue... Je suis complètement nu... Seule Lisa est encore timide... Mais je pense qu'avec le temps, si ce genre de rencontre devient une tradition, elle s'y habituera et en plus, elle commencera à se déshabiller elle-même ! Il n'y a pas de mal à rêver. L'essentiel est de ne pas lui mettre la pression, de la laisser s'habituer... Il est possible que, secrètement, elle aime vraiment tout ce qui se passe !"

    # game/core/09_opportunities.rpy:4
    old "Нужно продолжать общаться с Оливией, когда она бывает у нас в гостях. По вторникам и пятницам..."
    new "Je dois continuer à parler avec Olivia lorsqu’elle nous rend visite. Les mardis et vendredis..."
    ...
    new "Olivia m'a parlé de certaines de ses préoccupations... Après qu'Alex ait découvert par elle combien notre maison était cool et chère, il a rapidement retourné sa veste et a commencé à montrer beaucoup d'intérêt pour Lisa. On dirait qu'Alex est l'arriviste type... Maintenant, l'important est de faire comprendre ce fait à Lisa d'une manière discrète ! Je pense qu'elle viendra me demander conseil tôt ou tard... Et plus d'une fois que ce sera fait..."
    ...
    new "Lisa se tournera certainement vers moi pour obtenir des conseils. Il suffit d’être prêt à les lui donner, de bons conseils, pour qu’elle fasse le bon choix..."
    ...
    new "Voilà qui résout tout avec cet Alex ! Olivia l'a largué et Lisa a été déçue par lui. Bien que, si je n'avais pas eu d'indices, Lisa aurait certainement fait quelque chose de stupide et cette première nuit chez Olivia aurait pu être sa dernière... Mais Lisa a fait une chose stupide dans sa joie - elle a enlevé son T-shirt juste devant mes yeux ! C'est une chose stupide et très agréable à faire ! Il est vrai qu'elle a laissé entendre que cela pourrait rester un incident isolé, alors il vaut mieux que je fasse tout ce que je peux pour que ma petite sœur se sente protégée par moi..."
    ...
    new "Si je veux continuer à voir ma petite sœur sans T-shirt par moments, alors je dois essayer de la protéger des punitions de ma mère, aussi au moins l'aider un peu pour les devoirs, le massage de mes mains et le lavage de la vaisselle peut aider..."
    ...
    new "Donc, dans la nouvelle école, Lisa n'était pas aussi excellente qu'avant. Apparemment, la nouvelle école exige un niveau de connaissances beaucoup plus élevé. C'est une bonne occasion de montrer mes connaissances scolaires et d'aider ma petite sœur à comprendre la matière... Ou l'empêcher d'avoir une bonne note et voir ma mère la punir ? Pourquoi ne pas lui demander quelque chose pour son aide ? Mais d'abord, je dois parler à Lisa et lui demander ce qu'elle pense de tout ça?"
    ...
    new "J'ai parlé à Lisa des leçons et lui ai laissé entendre que mon aide serait utile... pour certains services de sa part. Bien sûr, elle a dit non. Mais c'est pour maintenant. Jusqu'à la première punition. Une fois qu'elle aura reçu une fessée devant moi, tout changera ! Mais pour ce faire, je dois m'assurer qu'elle obtienne un D à nouveau..."

    # game/core/09_opportunities.rpy:4
    old "Нужно просто подождать, пока она получит двойку и её накажут. Посмотрим, что она скажет после этого..."
    new "Je n'ais qu’à attendre qu’elle obtienne un deux et soit punie. On verra ce qu’elle dira après..."
    ...
    new "J’ai parlé à Lisa et lui ai promis que je l’aiderais avec les leçons. Et, absolument gratuitement. C’est-à-dire pour rien. Bien sûr, ce n’est pas très typique pour moi, mais il y a toutes les chances d’établir une relation avec ma sœur et de gagner sa confiance ... Pour commencer, au moins six fois l'aider pour faire ses devoirs. Cela devrait suffire pour qu’elle commence à espérer mon aide et à l’attendre à chaque fois."
    ...
    new "Je crois que j'ai convaincu Lisa de m'obéir sous peine d'être punie. Maintenant, elle ne dormira que dans un t-shirt et un slip. Eh bien, rien, je viens de commencer.\n\nMaintenant, je peux, sous le couvert de l'aide avec les leçons, ajuster les calculs afin qu'elle soit mise en deux et que vous puissiez regarder à nouveau sa punition... Qui sait, peut-être réussira-t-il à la diluer pour quelque chose de plus?"

    # game/core/09_opportunities.rpy:4
    old "Лучше, если Лиза будет делать домашнее задание в одежде посвободнее той, в которой мы заехали в этот дом..."
    new "Il vaut mieux que Lisa fasse ses devoirs dans des vêtements plus libres que ceux dans lesquels elle se promène dans la maison habituellement..."

    # game/core/09_opportunities.rpy:4
    old "Мама обязательно должна наказать Лизу. Иначе сестрёнка не поймёт, насколько сильно нуждается во мне..."
    new "Maman doit punir Lisa. Sinon, ma sœur ne comprendra pas à quel point elle a besoin de moi..."

    # game/core/09_opportunities.rpy:4
    old "Стоит попробовать уговорить Лизу сделать что-нибудь эдакое, прямо перед тем, как помочь ей с домашним заданием..."
    new "Cela vaut la peine d’essayer de persuader Lisa de faire quelque chose comme ça, juste avant de l’aider à faire ses devoirs..."
    ...
    new "J’ai aidé Lisa avec des leçons pendant un certain temps, et gratuitement. Maintenant, il est temps de lui montrer à quel point elle a besoin de mon aide et d’arrêter de l’aider. Ou même faire une erreur dans ses devoirs. Ensuite, elle aura rapidement une mauvaise note et notre mère la punira. Comme cela, je peux influencer plus Lisa que si j’arrêtais simplement de l’aider. Je dois décider quoi faire..."
    ...
    new "Je dois simplement arrêter simplement d’aider et attendre que Lisa obtienne un deux ou fasse des erreurs dans ses devoirs? C'est ce qui est mieux..."
    ...
    new "Et donc, après un autre deux et une punition de ma mère, elle s’est tournée vers moi pour obtenir de l’aide. J’ai accepté, mais à la condition qu’elle ne dorme que dans un T-shirt et une culotte. Et je pense que je vais pouvoir la faire changer sur autre chose..."
    ...
    new "Je ne pensais pas que ça marcherait, mais j’ai réussi à persuader Lisa à une autre incitation... Elle m’a montré ses mignons petits seins! Je ne les avais encore jamais vu de si près! Ils sont super! Mais oui, je ne dois pas oublier que ce n’est pas pour rien et que je dois l'aider à faire ses devoirs. Maintenant, je suis encore plus curieux, qu’est-ce qu’elle peut accepter d’autre, si je peux l’aider?"

    # game/core/09_opportunities.rpy:4
    old "Потребуются успехи в возможности \"Талантливый массажист\"..."
    new "Réussir dans 'l'opportunité' : 'Masseur talentueux', sera nécessaire..."

    # game/core/09_opportunities.rpy:4
    old "Потребуются успехи в возможности \"Шаловливые ножки\"..."
    new "Il faudra réussir dans 'l'opportunité' : 'Jambes coquines'..."

    # game/core/09_opportunities.rpy:4
    old "Стоит почаще уговаривать Лизу показать грудь. Лучше всего, когда она в очень хорошем настроении..."
    new "Ca vaut la peine de persuader souvent Lisa de montrer ses seins. Le meilleur moment, quand elle est de très bonne humeur..."
    ...
    new "Avec Alice nous avons encore des discutions sympathiques! J’ai dit à Lisa quel massage cool je lui faisais. C’est une bonne chose parce que Lisa l’a demandé elle-même de se faire masser. Maintenant, je peux masser ses jambes minces pendant qu’elle fait ses devoirs. Et admirer ce qui se cache sous ses vêtements. Peut-être que si elle aime la façon dont je masse ses jambes, elle voudra masser autre chose?"

    # game/core/09_opportunities.rpy:4
    old "Пусть Лиза поймёт, что я хорош в массаже ног. Нужно массировать её ножки почаще..."
    new "Je dois faire savoir à Lisa que je suis douée pour le massage des pieds. Je dois masser ses jambes plus souvent..."
    ...
    new "On dirait que Lisa commence à aimer mon massage. Elle m’a même demandé si je pouvais lui masser les mains. Je sais parfaitement comment ses mains se fatiguent parfois pour écrire pour l'école, et les mardis et vendredis Lisa est particulièrement fatiguée. Donc, ces jours-là, il est préférable de s’exécuter et avant de s’asseoir pour les devoirs, masser ses mains. Il est possible qu’après avoir réussi dans le massage des mains, Lisa ne se souciera pas que je masse encore autre chose."

    # game/core/09_opportunities.rpy:4
    old "Нужно начать с покупки хотя бы одного урока массажа рук и уже только после этого переходить к практике..."
    new "Je dois commencer par l’achat d’au moins une leçon de massage des mains et seulement après cela procéder au massage..."
    ...
    new "Plus je peux apprendre avec les cours de massage des mains, plus je peux les appliquer efficacement les leçons apprises. Le meilleur moment pour un massage des mains est quand Lisa est au téléphone..."
    ...
    new "Maintenant, je peux masser à Lisa non seulement ses jambes, mais aussi ses mains. Un peu de pratique et tout ira bien. Peut-être même si le massage se passe bien, elle voudra que je masse autre chose que ses jambes? Par exemple, ses épaules... Certes, elles sont aussi tendues."
    ...
    new "Si je peux terminer avec succès le massage des mains et des jambes, pendant les devoirs, alors il vaut la peine d’essayer de persuader Lisa de lui masser les épaules ..."
    ...
    new "Si je donne à Lisa assez d’attention dans tout ce que je fais, alors après un massage des épaules, je peux essayer d’aller encore plus loin. Ou plutôt, plus bas..."
    ...
    new "On dirait que je connais déjà bien le massage! Bien que, pas seulement dans ce massage... Notre relation avec Lisa n’est plus seulement étroite, mais parfois intime. Bien sûr, jusqu’à présent, sous une forme plutôt inoffensive, mais tout ne fait que commencer. Comme je voudrais aller, avec ma petite sœur, au-delà de tous ces baisers, mais c’est déjà très bien."
    ...
    new "Curieux. Alice semble avoir une peur bleue des araignées. Et il faut noter que le climat ici est très adapté à ce genre d'insectes... Je dois en attraper une et la donner à Alice, ce sera amusant ! Mais comment et où les trouver ?"
    ...
    new "J'ai fait des recherches sur Internet et j'ai découvert qu'une espèce d'araignée est très facile à trouver dans notre région. Heureusement, elle est totalement inoffensif, mais sa taille peut être assez importante. On ne peut pas les trouver la nuit, mais lorsque le soleil commence à réchauffer le sol, elles rampent à la lumière et examinent leurs proies."
    ...
    new "Alors, j'ai attrapé une énorme araignée. Ce n'est pas si difficile si vous savez à quelle heure et où les attraper. Maintenant je dois tester ce monstre sur ma sœur. Il s'agit juste de choisir le bon moment... Je me demande si elle remarquera l'araignée si elle se douche ?"
    ...
    new "Oh, oui ! Alice a définitivement peur des araignées ! Je n'ai jamais vu les fesses de ma grande sœur si mouillées et tremblantes de peur... Tous les voisins du quartier ont entendu les hurlements, c'est sûr ! Sauf que si Alice découvre que je l'ai fait exprès, je serais mort. Avant que cela n'arrive, je peux essayer de mettre une araignée dans sa chambre..."

    # game/core/09_opportunities.rpy:4
    old "Лучше подкладывать паука прямо перед тем, как Алиса соберётся спать. Иначе у паука будет больше времени, чтобы сбежать..."
    new "Il est préférable de mettre l’araignée juste avant qu’Alice ne se couche. Sinon, l’araignée aura plus de temps pour s’échapper..."
    ...
    new "Alice a tellement peur des araignées qu'elle est venue me chercher en courant au milieu de la nuit ! Alice est si sexy dans ses sous-vêtements, mmm. Et on dirait qu'il y a beaucoup de choses qu'elle peut être tentée de faire sous peine de passer une nuit avec une araignée, donc je ne la vois certainement pas pour la dernière fois ! Peut-être mettre une araignée à côté d'elle quand Alice prend un bain de soleil ?"

    # game/core/09_opportunities.rpy:4
    old "Лучше подложить паука, когда я делаю Алисе массаж. Если она хорошенько расслабится, то сильнее испугается..."
    new "Mieux vaut mettre une araignée quand je fais un massage à Alice. Si elle se détend bien, elle aura plus peur..."
    ...
    new "Un câlin si serré d'Alice, je ne m'y attendais pas ! Ses seins n'ont jamais été aussi proches de mon visage ! Avec l'aide des araignées, je peux m'offrir un tas de moments assez excitants avec Alice... Voyons voir où cela va me mener..."

    # game/core/09_opportunities.rpy:4
    old "Алиса должна как можно меньше меня стесняться. Для этого нужны успехи в возможности \"Забота о попках\"..."
    new "Alice devrait être gênée le moins possible. Cela nécessite de réussir dans 'l'opportunité' : 'Soins du cul'..."

    # game/core/09_opportunities.rpy:4
    old "Хорошо бы нам с ней быть, как можно более раздетыми. Я в одних шортах, а Алиса без верха купальника..."
    new "Ce serait bien pour elle et moi d’être aussi nus que possible. Je suis en short, et Alice n’a pas le haut du maillot de bain..."
    ...
    new "Voilà qui est intéressant ! Je pensais qu'Alice allait, comme d'habitude, me gronder après avoir serré ma bite en se cachant de l'araignée... Mais, non ! En plus, elle a même réussi à... être gentille avec moi... Ou plutôt, elle a été plus détendue au sujet de mon 'excitation'...! C'est étrange... Peut-être qu'elle a enfin compris que les araignées sont bien plus effrayantes que ma trique ! Si c'est le cas, c'est une très bonne chose, car beaucoup de choses seront différentes avec Alice maintenant..."
    ...
    new "Je n'ai pas harcelé Alice la nuit. C'était un chemin clair pour retourner à ma chambre avec des béquilles. Mais le matin, alors qu'Alice dormait encore, c'était une autre affaire... \nJ'avais, bien sûr, vu ses seins un tas de fois auparavant, mais c'était toujours très agréable de baisser son soutien-gorge et tout aussi agréable que cela ne la réveille pas. Le plus important, c'est que j'ai pu aller dans son lit et que je peux maintenant passer à autre chose. \n\nJe me demande ce qui se passera si elle se réveille à mes avances ? C'est ce que nous devons découvrir..."

    # game/core/09_opportunities.rpy:4
    old "Желательно, чтобы Алиса проснулась от моих приставаний..."
    new "De préférence, Alice se réveille à cause de mon harcèlement..."
    ...
    new "Eh bien, je suis vivant, en bonne santé et plein d'énergie, prêt à continuer à harceler Alice. Elle m'a peut-être demandé d'arrêter de la harceler, mais je sais que c'est ce qu'elle veut. Et elle doit le montrer la prochaine fois... \nJe suis sûr que je vais devoir la convaincre de rester pour la nuit maintenant, mais ce n'est pas la première fois que je dois le faire."

    # game/core/09_opportunities.rpy:4
    old "Нужно продолжать оберегать Алису от пауков в её комнате..."
    new "Nous devons protéger Alice des araignées dans sa chambre..."
    ...
    new "Oh, quelle farceuse Alice s'est avérée être ! Allongé là, faisant semblant de dormir, et soudain... elle est déjà en train de me branler... Et elle trouve des excuses ! Maintenant je sais ce qu'elle a en tête et je devrais répondre de la même manière... la prochaine fois... la prochaine fois que je passe la nuit avec elle..."
    ...
    new "Ça devrait fonctionner correctement si Alyssa a au moins deux fois de plus où je lui fais un massage des pieds sobre près de la télé."
    ...
    new "Tout devrait fonctionner correctement si Alice travaille ses pieds à jeun au moins une fois de plus quand je la masse devant la télé"
    ...
    new "Eh, Alice perd son emprise... Elle me menaçait de toutes parts, mais je m'en fichais... J'ai juste mis ma langue dans sa chatte. Et la façon dont je l'ai baisée au plus fort de sa félicité... Elle saura que je suis humain aussi et voudra venir... sur elle... Voyons si elle y pense. \nEt en attendant, je ferais mieux d'arrêter de mettre des araignées dans sa chambre, c'est déjà très suspect. \nOh, peut-être que maintenant elle me laissera entrer quand elle se douchera?"

    # game/core/09_opportunities.rpy:4
    old "Пустит ли меня Алиса к себе в душ для охраны, если её будет терроризировать паук? Стоит проверить..."
    new "Alice me laisserait-elle entrer dans sa douche de sécurité si elle était terrorisée par une araignée ? Cela vaut la peine de vérifier..."
    ...
    new "Quelle chance j'ai eu d'être utile à Alice ! J'étais là où et quand elle avait besoin de moi pour sauver son cul mouillé de l'araignée. Et à en juger par le fait qu'elle m'a laissé toucher ce cul et a laissé entendre que je devrais me souvenir de lui frotter le dos la prochaine fois, elle était arrivée à de bonnes conclusions. Du moins, je pense qu'elle l'a fait. La seule question est, combien de temps encore va-t-elle s'effondrer ? Ugh... Je ne peux pas attendre le jour où elle se douchera seule..."
    ...
    new "L'araignée semble être plus un obstacle qu'une aide maintenant. J'arrivais juste à la bonne partie avec Alice quand il s'est faufilé et a tout gâché. Je ne dirais pas tout, car j'ai reçu un baiser reconnaissant d'Alice, et j'ai frotté ma bite sur son cul pendant qu'elle était accrochée à moi... Mais j'aurais pu avoir plus... Peut-être que la prochaine fois, j'aurai la chance de repérer l'araignée en premier."
    ...
    new "Donc, j'ai rencontré ce Eric, le petit ami de maman. Je ne peux rien dire de bon ou de mauvais sur lui, mais je ne l'aimais pas beaucoup déjà avant son arrivée. Presque immédiatement, il m'a offert le choix d'être ami avec lui ou de me battre avec lui. Mais pourquoi devrais-je être ami avec lui ? A quoi cela servirait-il ? Et pour se battre... Qu'est-ce qu'il peut me faire ? Quoi qu'il en soit, il m'a donné une semaine de réflexion. Eh bien, je vais y réfléchir et décider ce qui est juste..."

    # game/core/09_opportunities.rpy:4
    old "Буду думать. Что ещё остаётся..."
    new "Je vais y penser. Ce qu'il reste d'autre..."
    ...
    new "Avec l'arrivée d'Eric, mes affaires ont pris une tournure inattendue... D'abord, il a proposé de m'envoyer dans un camp militaire. Pour faire de moi un homme... Je suis déjà un homme ! Je ne me soucie pas de ces camps...\\n\\nDeuxièmement, il a convaincu ma mère que nous devions être punis d'une autre manière. J'aimerais pouvoir dire quelque chose de bien, mais c'est... Quoi qu'il en s\\nJe sais que ce serait amusant de voir les seins de mes sœurs, mais je pourrais aussi me faire fouetter devant tout le monde. Quel coup dur pour ma crédibilité !\\n\\nD'abord cette idée stupide d'un camp militaire, maintenant ça... Il est urgent de faire quelque chose !"
    ...
    new "Je dois sérieusement réfléchir à la question de savoir si je dois être ami avec Eric ou non. Si je deviens son ami, j’aurai peut-être moins de problèmes, mais je ne sais pas si des opportunités ne vont plus apparaître. Si je lui deviens hostile, je pourrais bien entrer dans un camp militaire ou pire. Une alternative, je peux être son amis, mais à chaque occasion de lui mettre des bâtons dans les roues..."
    ...
    new "Eh bien, j'ai l'impression d'avoir fait un pacte avec le diable. Eric a promis de me verser de l'argent et m'a permis de les espionner avec ma mère. Si de mon côté, je ne l'empêche pas de séduire ma famille... Qui sait, peut-être cela me permettra-t-il de participer avec eux à quelque chose de lubrique..."
    ...
    new "Peu importe comment notre relation avec Eric se développe, je dois le salir aux yeux de ma famille. Ce ne sera pas superflu. Tôt ou tard, il dragueras mes sœurs et c’est là que je l’attraperai sur quelque chose..."
    ...
    new "Alors tante Kira, la petite sœur de maman, est venue nous rendre visite. Bien sûr, on ne l'avait pas vue comme quelqu'un de complexé, mais maintenant elle est devenue si... tellement... Elle a aussi vu ma bite, le premier jour ! C'est si embarrassant. Mais tante Kira s'est aussi montrée dans toute sa beauté, en maillot de bain, si on peut appeler ça un maillot de bain... Et puis il y a les insinuations sur mon père. Étaient-ils vraiment si... familier avec elle? Je dois apprendre le maximum possible d'elle."

    # game/core/09_opportunities.rpy:4
    old "Тётя Кира - женщина интересная. С ней стоит побольше общаться..."
    new "Tante Kira est une femme intéressante. Cela vaut la peine de lui parler plus..."
    ...
    new "J’ai tout dit à tante Kira sur Eric, c’est comme ça, alors je l’ai dit. Elle semble douter de mes paroles, mais a promis de tout découvrir avec soin. Peut-être même qu’Eric lui-même en parlera... Il est peu probable que cela se produise bientôt, car tante Kira passe beaucoup de temps au travail et revient très tard. Alors, je peux regarder ce que Kira fait avant d’aller au lit..."

    # game/core/09_opportunities.rpy:4
    old "Тётя Кира вполне перед сном может посмотреть что-нибудь по ТВ. Неплохо было бы подсмотреть, что именно..."
    new "Tante Kira pourrait bien regarder quelque chose à la télévision avant d’aller se coucher. Ce serait bien de voir ce que c’est exactement..."
    ...
    new "Tante Kira est une salope! Elle regarde du porno la nuit et pense que personne ne la verra. Je peux essayer de lui tenir compagnie... J’espère qu’elle n’est pas aussi stricte à ce sujet que ma mère. Si seulement mon habileté à la persuasion suffisait..."
    ...
    new "Il vaut la peine d’acheter au moins quatre leçons sur la communication, afin que j’aie une meilleure chance de persuader tante Kira de regarder la tv ensemble..."
    ...
    new "J’ai adoré! Tante Kira et moi nous nous sommes non seulement regardés, mais nous nous sommes aussi caressés. Je ne sais même pas ce qui m’excitait le plus : ce qu'il y avait sur grand écran ou tante Kira en chemise de nuit qui se caressait à travers sa culotte juste devant moi. Bien que, pourquoi être si évasif... C’est définitivement tante Kira! Peut-être qu’elle fait quelque chose comme ça en prenant un bain?"

    # game/core/09_opportunities.rpy:4
    old "Я не смогу подсмотреть за тётей Кирой в ванной комнате. Нужны успехи в возможности \"Скрытые камеры\"..."
    new "Je ne peux pas espionner tante Kira dans la salle de bain. J'ai besoin de réussir dans 'l'opportunité' : 'Caméras cachées'..."

    # game/core/09_opportunities.rpy:4
    old "Потребуются успехи в возможности \"Школьница\"..."
    new "Il faudra réussir dans 'l'opportunité' : 'Collégienne'..."

    # game/core/09_opportunities.rpy:4
    old "Стоит подсмотреть со стремянки, как тётя Кира принимает ванну. Вдруг удастся увидеть что-то интересное..."
    new "Cela vaut la peine de jeter un coup d’œil depuis l’escabeau, car tante Kira prend un bain. Peut-être que je pourrais voir quelque chose d’intéressant..."
    ...
    new "Heureusement que je n'ai pas abandonné, je suis allé voir tante Kira dans la salle de bain. Bien sûr, je savais qu’après ce que nous avons regardé, elle ne me gronderait pas, mais j'avais encore des craintes. Je ne m’attendais pas à ce qu’elle m’invite à se joindre à elle et à demander un massage des pieds! La vue, bien sûr, était superbe. Elle a même joué un peu avec son corps, comme par accident, mais elle et moi savions que ce n’est pas une coïncidence... Nous devrions répéter tout cela. Et si je brille encore dans le travail avec les pieds de tante Kira à l’avenir, alors je dois essayer de ne pas trop aller vite, pour profiter correctement de ce moment."

    # game/core/09_opportunities.rpy:4
    old "Надеюсь, рано или поздно я привыкну к этим нежным ножкам, которыми она массирует мой член и не буду кончать так быстро..."
    new "J’espère que tôt ou tard, je m’habituerais à ces jambes tendres avec lesquels elle me masse ma bite et ne plus jouir si vite..."
    ...
    new "Comme c’est cool de prendre un bain avec tante Kira! Elle caresse sa chatte avec tant de passion qu’elle me donne des coups de pied dans la bite... Je veux mettre mes doigts et ma langue en elle pour qu’elle gémisse encore plus fort. Et je pense que le meilleur moment pour cela, c’est quand elle m’apprend à embrasser. J’en étais déjà très proche, mais maintenant, après tout ce plaisir dans le bain, il est temps d’agir..."
    ...
    new "J’ai besoin de jeter toutes mes forces dans les leçons de baiser avec tante Kira et de la captiver avec des baisers pour qu’elle me permette de caresser sa chatte! Et puis peut-être qu’elle me répondra par quelque chose en retour..."
    ...
    new "Maintenant, je sais comment amener ma tante avec mes doigts et ma langue à l’orgasme! Et c’est incroyablement cool! Et ce qui est particulièrement cool, c’est ce qu’elle fait en réponse... Je ne me rendais pas compte à quel point j’avais une grosse bite avant. Mais tante Kira à peine réussi à le prendre dans sa bouche et c’était irrésistiblement agréable! Il semblerait que je devrais me demander si tout cela est juste, parce qu’elle est ma tante? Mais quelle différence, parce que nous passons de si bons moments. Et au fait, Kira a-t-elle parlé d’Eric à ma mère ?"
    ...
    new "Au fait, puisque Kira et moi sommes maintenant très proches, je peux maintenant flirter avec elle et regarder du porno ensemble, et être ensemble dans le bain, et je peux même essayer quelque chose dans la piscine!"

    # game/core/09_opportunities.rpy:4
    old "Неплохо бы поинтересоваться у тёти Киры, пока она загорает о том, поговорила ли она с мамой..."
    new "C’est une bonne idée de demander à tante Kira pendant qu’elle prend un bain de soleil si elle a parlé à ma mère..."
    ...
    new "Mon Dieu! Ma tante est dans le porno! Est-ce que je vis à côté d’une étoile de X? Maintenant, il est clair pourquoi je suis si attiré par ça. Elle est juste tellement chaude! Peut-être que se rapprocher encore plus d’elle ne sera pas aussi difficile que je le pensais..."
    ...
    new "Kira m’a offert de l’argent. J'ai juste besoin de la prendre en photo. Heureusement que j’ai déjà un bon appareil photo! Bien sûr, il est peu probable qu’elle me paie autant que ça coûte, mais il y a une chance que je fasse autre chose pour cette séance photo... Et s’il s’agit d’une séance photo pour un portfolio, je peux faire à Kira un cadeau. Par exemple, lui acheter une chemise sexy pour elle! Cela ne va aller qu’à moi..."

    # game/core/09_opportunities.rpy:4
    old "Если есть деньги, то купить сорочку не трудно..."
    new "Si j'ai de l’argent, il n’est pas difficile d’acheter une chemise ..."

    # game/core/09_opportunities.rpy:4
    old "Главное дождаться субботы, когда все уедут на шопинг..."
    new "L’essentiel est d’attendre samedi, quand tout le monde ira faire du shopping..."
    ...
    new "Kira m’a offert de l’argent. J'ai juste besoin de la prendre en photo. C’est juste à ces fins que j'ai besoin d’un appareil photo. Bien sûr, il est peu probable qu’elle me paie autant que l’appareil photo, mais il y a une chance que quelque chose d’autre se passe dans cette séance photo... Et s’il s’agit d’une séance photo pour un portfolio, je peux faire à Kira un cadeau. Par exemple, lui acheter une chemise sexy pour elle! Cela ne va aller qu’à moi..."

    # game/core/09_opportunities.rpy:4
    old "Если есть деньги, то купить фотоаппарат и сорочку не трудно..."
    new "Si j'ai de l’argent, il n’est pas difficile d’acheter un appareil photo et une chemise ..."
    ...
    new "La séance photo était cool, même si je n’ai rien découvert de nouveau pour moi. Eh bien, il y a eu des moments presque intéressants, et c’est beaucoup mieux que rien du tout! Maintenant, je dois attendre un peu pour le développement de ces images. Peut-être que je pourrais avoir des retombées pour cette séance photo..."

    # game/core/09_opportunities.rpy:4
    old "Стоит подождать хотя бы до понедельника и можно будет поинтересоваться у Киры, какой из меня фотограф..."
    new "Cela vaut la peine d’attendre au moins jusqu’à lundi et je peux demander à Kira quel photographe suis-je..."
    ...
    new "Donc, les photos sont sorties réussies et Kira et moi avons convenu d’une nouvelle séance photo quand personne ne sera à la maison. Mais on ne sait pas encore quand on le fera... Je me demande ce que Kira veut obtenir pour ce tournage?! Je ne peux qu’attendre... Et cette attente est quelque chose à égayer, surtout que je n'ai pas perdu avec le don de la chemise.. Tante Kira m’a remercié avec une fellation quand je n'espérais pas plus! Très agréable!"

    # game/core/09_opportunities.rpy:4
    old "Подожду недельки полторы и поинтересуюсь, готова ли тётя Кира к новой фотосессии..."
    new "Je vais attendre une semaine et demie et demander si tante Kira est prête pour une nouvelle séance photo..."
    ...
    new "La deuxième séance photos a eu lieu! C'était géniale! Non seulement parce que Kira a décidé de prendre des photos en tenue BDSM, mais aussi parce que nous avons fait l'amour... Mon premier vrai acte sexuel... Je suis maintenant officiellement plus vierge! Ou plutôt, officieusement... J'ai baisé ma tante. J'espère que ce ne sera pas la dernière fois! Mais il vaut mieux être très prudent avec cet Eric, qui se mêle de tout..."
    ...
    new "J’ai finalement parlé à tante Kira du comportement de ma mère et elle a laissé entendre qu’elle en connaissait les raisons, mais qu’elle ne pouvait pas me le dire jusqu’à ce que ma mère l'accepte. Ou peut-être qu’elle me dira tout elle-même ? J'ai juste besoin de faire allusion à l'histoire de son enfance ..."

    # game/core/09_opportunities.rpy:4
    old "Нужно поговорить об этом с мамой, когда она одна и не слишком занята..."
    new "Je dois en parler avec ma mère quand elle est seule et pas trop occupée..."
    ...
    new "Ma mère a catégoriquement refusé de parler avec moi de son incident dans son enfance, auquel tante Kira a fait allusion. Maintenant, je sais quoi creuser, mais je ne sais pas qui peut m'expliquer quelque chose... Peut-être que je peux convaincre tante Kira de tout me dire en secret ?"

    # game/core/09_opportunities.rpy:4
    old "Нужно пытаться убедить Киру рассказать мамин секрет..."
    new "Il faut essayer de convaincre Kira de me dire le secret de ma mère..."
    ...
    new "Finalement, j’ai réussi à convaincre tante Kira de me raconter ce qui est arrivé à ma mère quand elle était petite. De toute évidence, le traumatisme psychologique que ce ravisseur dans les bois lui a infligé a eu un impact sérieux sur ce qu’elle est devenue. Eh bien, Eric, son patron, était la raison parfaite pour que toutes les conséquences de cette blessure réapparaissent, mais... d’une manière étrange..."

    # game/core/09_opportunities.rpy:4
    old "Через несколько дней нужно будет поинтересоваться у Киры, когда будет новая фотосессия..."
    new "Dans quelques jours, je dois demander à Kira quand il y aura une nouvelle séance photo..."
    ...
    new "Je me demande ce à quoi tante Kira a pensé, elle veut que nous nous amusions plus la nuit pour que je puisse supporter la nouvelle séance photo? Et elle a besoin de négocier avec quelqu’un... Quoi et avec qui, mystère. Et apparemment, je n'obtiendrais de réponses que lors de la séance photo elle-même..."

    # game/core/09_opportunities.rpy:4
    old "Кира сказала, что сама со мной поговорит, когда для фотосессии всё будет готово. Остаётся ждать..."
    new "Kira m’a dit qu’elle me parlerait quand tout serait prêt pour la séance photo. Il reste qu'à attendre..."
    ...
    new "Je me demande ce que tante Kira a dans la tête pour qu'il soit si important pour elle que nous nous amusions suffisamment la nuit pour que l'on puisse faire cette nouvelle séance photo? Mais ce que je sais avec certitude, c’est qu’elle pense que je ne tiendrais pas jusqu’à la fin de la séance photo, elle ne sera pas déçue. Si tante Kira veut travailler sur mon endurance, alors il faut me retenir le plus longtemps possible pendant nos séances avec elle !"

    # game/core/09_opportunities.rpy:4
    old "Максимально долго не кончал при минете от Киры после секса: [kira.flags.held_out] из 3"
    new "Le plus longtemps possible; j'ai tenu après le sexe avec Kira : [kira.flags.held_out] sur 3"
    ...
    new "La séance photo s’est avérée encore meilleure que je n’aurais pu l’imaginer! Surtout à la toute fin... Cette amie photographe de Kira est une personne très mystérieuse. Elle a d’abord filmé comment Kira et moi baisons, puis elle nous a rejoints! C’est un rêve de faire tout ce à quoi je rêve avec deux femmes à la fois. Certes, cette fois, l’initiative était complètement de leurs côté, mais cela ne me dérangerait pas de m’amuser davantage avec elles! Et pourquoi Kira cache-t-elle autant son identité? Aller, Kira a dit que je la reverrais, mais en attendant, je suis plus intéressée par le fait que ma tante va faire ses propres projets et s’attend à ce que je l’aide dans ce domaine. J’aurai besoin de lui en parler dans un moment..."

    # game/core/09_opportunities.rpy:4
    old "Кнут или пряник?"
    new "Carotte ou bâton ?"
    ...
    new "Lisa a remarqué que je la regardais sous la douche. J'ai essayé de m'excuser et j'ai promis de lui acheter des sucreries. En retour, Lisa ne dira rien à notre mère, mais je n'ai pas beaucoup de temps..."
    ...
    new "Je dois me dépêcher avec l’achat de friandises! Il semble que Lisa ait dit un jour qu’elle n’aimait pas certaines friandises. Quoi qu’il en soit, je n'ai pas beaucoup de temps ..."
    ...
    new "Malheureusement, je n'ai pas donné de sucreries à Lisa à temps et elle a raconté à notre mère comment je l'avais espionnée. Peut-être que la prochaine fois, si Lisa me remarque, j'aurai le temps de..."

    # game/core/09_opportunities.rpy:4
    old "Но не стоит торопиться... Если Лиза заметит меня за тем же самым занятием, спустя всего лишь пару дней, будет только хуже."
    new "Mais je ne dois pas me précipiter... Si Lisa remarque que je fais tout le temps la même chose, dans quelques jours, ça ne fera qu’empirer."

    # game/core/09_opportunities.rpy:4
    old "Главное, чтобы были деньги на покупку сладостей, а остальное - уже ерунда..."
    new "L’essentiel est qu’il devrait y avoir de l’argent pour acheter des friandises, et le reste est déjà prévu..."
    ...
    new "J'ai acheté des 'Ferrero Rocher' pour Lisa et il s'avère qu'elle n'aime pas du tout ça! La prochaine fois, il vaut mieux lui donner autre chose..."

    # game/core/09_opportunities.rpy:4
    old "Зато, теперь известно, какие сладости Лиза не любит. Я это запомню..."
    new "Mais, maintenant, on sait ce que Lisa n’aime pas ceux là. Je vais m’en souvenir..."
    ...
    new "J'ai acheté des Raffaello pour Lisa. et elle les a acceptés, mais sans grand enthousiasme! Peut-être que la prochaine fois je devrais lui donner autre chose?"

    # game/core/09_opportunities.rpy:4
    old "Зато, теперь известно, за какие сладости Лиза почти наверняка не сдаст меня маме. Я это запомню..."
    new "Mais, maintenant, c'est certain, Lisa ne me dénoncera certainement pas à notre mère. Je vais m’en souvenir..."
    ...
    new "J'ai acheté du chocolat Ritter Sport pour Lisa et elle était très heureuse! Il s'est avéré que c'était sa friandise préférée! Peut-être que la prochaine fois, je devrais lui offrir une plus grosse boîte de chocolats?"
    ...
    new "C’était tellement stupide! Et pourquoi ai-je espionné Lisa si effrontément, et même sans attendre au moins quelques jours?! Je ne discute pas, j’ai été puni devant tout le monde pour ça, mais il vaut mieux ne plus le faire et attendre un peu."
    ...
    new "La leçon a été renforcée par la douleur et l’humiliation. Et où est ma patience? Il est nécessaire de ne pas espionner Lisa pendant au moins trois jours, afin que cela ne se reproduise plus.."
    ...
    new "Il s'avère que je peux recevoir un gros câlin si je donne ses sucreries préférées à Lisa ! Et ce malgré le fait que je la reluquais. Voyons voir ce que je peux obtenir d'autre de ma sœur..."
    ...
    new "Maintenant, il est clair à quel point il est plus facile de convaincre Lisa de ne pas me dénoncer à ma mère. Mais je ne risque pas de l’espionner dans les prochains jours, comme on a convenu..."
    ...
    new "Un câlin n'était pas la seule chose que j'ai eu de Lisa pour les chocolats. Elle était si excitée qu'elle m'a même donné un baiser sur la joue ! Je ne pensais pas qu'épier ma sœur pouvait s'avérer être une si bonne surprise ! Je me demande ce qui va se passer ensuite..."
    ...
    new "C’est exactement comme ça que je devrais m’excuser auprès de Lisa! Mais je ne risque pas de l’espionner dans les prochains jours, comme nous l'avons convenu..."
    ...
    new "On dirait que les chocolats à Lisa ne suffisent plus et qu'elle veut une robe de chambre comme celle d'Alice. C'est déjà un achat conséquent! J'ai plus de temps cette fois-ci, mais il faut quand même se dépêcher avec le cadeau. Je me demande ce qui m'attend..."

    # game/core/09_opportunities.rpy:4
    old "У меня всего пара дней. Дело плёвое, если есть деньги..."
    new "Je n'ai que quelques jours. Ce n'est pas une grosse affaire, si j'ai de l'argent..."
    ...
    new "Mes cadeaux font que Lisa ne se contente plus de m'embrasser sur la joue, mais qu'elle me saute dessus avec un gros câlin ! Il est peut-être temps pour moi d'être actif dans ces moments-là aussi. Donc le coup d'œil sera utile si je m'excuses correctement."
    ...
    new "Puisque Lisa ne demande plus de friandises pour mes offenses, alors je peux juste lui en donner de temps en temps pour lui remonter le moral. Et cela ne nuira certainement pas à notre relation. Une fois par semaine - la chose la meilleure à faire!"
    ...
    new "Peut-être que cela ne s’est pas passé de la meilleure façon, mais maintenant Lisa à la robe dont elle rêvait. J’espère que je pourrais lui mettre la main dessus un jour."
    ...
    new "Cette fois, Lisa n'a pas demandé de chocolats ou de vêtements... Elle a décidé de me 'punir' en m'obligeant à regarder des films ensemble avant d'aller au lit ! C'est bien, mais nous allons regarder des films romantiques... J'espère seulement que c'est supportable, parce que j'adore regarder Lisa prendre une douche."

    # game/core/09_opportunities.rpy:4
    old "Если Лиза заметила, как я за ней подглядывал, то лучше в полночь вернуться в нашу с ней комнату, чтобы посмотреть фильм..."
    new "Si Lisa m'avait vu la regarder, il est préférable de retourner dans notre chambre à minuit pour regarder le film..."
    ...
    new "L’idée de Lisa de regarder des films romantique s’est avérée meilleure que je ne le pensais! Du moins pour moi. Ma sœur est en sous-vêtements à côté de moi dans le même lit! Et à l’écran, il y a aussi des scènes chaudes qui excitent, vraiment, de sorte que j'ai bandé! Lisa n’était pas contente à cause de ça, mais je verrais ce qui se passera ensuite..."

    # game/core/09_opportunities.rpy:4
    old "Чтобы нам с Лизой было более комфортно с друг другом, понадобятся успехи в возможности \"Наставник\"..."
    new "Pour que Lisa et moi soyons plus à l’aise l’un avec l’autre, J'ai besoin de succès dans 'l'opportunité' : 'Mentor'..."

    # game/core/09_opportunities.rpy:4
    old "Нужно продолжать эти ночные просмотры дальше. Может, Лиза ко мне и привыкнет, а я к ней..."
    new "Je dois poursuivre ces visionnements nocturnes. Peut-être que Lisa s’habituera à moi, et que je m’habituerais à elle..."
    ...
    new "Lisa en avait assez que je bande devant des films romantiques et a décidé que nous allions regarder quelque chose qui ne me ferait pas bander: des films d'horreur! Oui, les films d'horreur avant de se coucher, dans le noir... J'ai une sœur désespérante !"
    ...
    new "Les films d'horreur ne sauvent pas non plus ma trique... Lisa se presse si fort contre moi avec son corps presque nu qu'il est difficile pour moi de me retenir et de ne pas être excité... Pourrais-je peut-être essayer de résister pour une fois, et alors Lisa ne s'enfurierait pas si vite ?"

    # game/core/09_opportunities.rpy:4
    old "Легко сказать! Но чем больше у меня будет сексуальных развлечений, тем проще мне будет сдерживаться с Лизой..."
    new "Facile à dire! Mais plus j'ai de plaisir sexuel, plus je peux me retenir avec Lisa..."
    ...
    new "Lisa s'est enfuie dans son lit, mais j'ai réussi à prendre un moment et à l'embrasser pour la nuit afin qu'elle n'ait pas si peur! Peut-être qu'avec le temps, je pourrais la déshabiller. Ce serait cool!"

    # game/core/09_opportunities.rpy:4
    old "Чтобы нам с Лизой было более комфортно с друг другом, понадобятся успехи в возможности \"Одноклассник\"..."
    new "Pour que Lisa et moi soyons plus à l’aise l’un avec l’autre, J'ai besoin de succès dans 'l'opportunité' : 'Camarade de classe'..."

    # game/core/09_opportunities.rpy:4
    old "Нужно чаще защищать Лизу от маминых наказаний. Это только на пользу нашим отношениям..."
    new "Il faut protéger Lisa plus souvent des punitions de maman. Ce n'est pas pour le bien de notre relation ces punitions..."
    ...
    new "Je me demande si Lisa acceptera de regarder des films d’horreur sans T-shirt?! Elle et moi sommes déjà devenus très proches, mais je ne sais pas comment la persuader de le faire. Mais il vaut mieux le faire le jour même où notre mère a voulu la punir."

    # game/core/09_opportunities.rpy:4
    old "Нужно защитить Лизу от маминого наказания, а затем, как можно быстрее, с ней поговорить..."
    new "Il faut protéger Lisa de la punition de sa mère et lui parler le plus vite possible..."

    # game/core/09_opportunities.rpy:4
    old "Времени немного. Нужно успевать до того, как Лиза ляжет спать..."
    new "Le temps presse. Il faut attendre que Lisa se couche..."
    ...
    new "Comme c'est gentil de ma part de suggérer que Lisa devrait être amie avec Olivia ! Grâce à elle, Lisa n'est plus la fille timide qui n'acceptait qu'un baiser occasionnel... Maintenant, je peux vraiment la convaincre de regarder des films d'horreur en petite culotte ! Il suffit de ne pas laisser maman la punir... Si il ne s'agit que de cela."
    ...
    new "J'ai jeté un coup d'œil à Alice qui prenait une douche et elle m'a vue. En essayant de m'excuser, j'ai promis de lui acheter des sucreries en échange de quoi elle ne dirait pas tout à notre mère. Étonnamment, je suis encore en vie, mais je n'ai pas beaucoup de temps..."
    ...
    new "Je dois me dépêcher avec l’achat de friandises! Si je me souviens bien, elle aime quelque chose avec un emballage doré. Quoi qu’il en soit, j'ai peu de temps..."
    ...
    new "Hélas, je n'ai pas donné les sucreries à Alice à temps et elle a raconté à notre mère comment je l'avais espionnée. Peut-être que la prochaine fois, si Alice me remarque, j'aurai le temps de..."
    ...
    new "Mais ne je ne dois pas me précipiter... Si Alice me surprend encore pour la même activité, après seulement quelques jours, il est préférable de quitter la maison tout de suite."

    # game/core/09_opportunities.rpy:4
    old "Я купил для Алисы конфеты \"Raffaello\" и как оказалось, они ей не нравятся! В следующий раз, лучше подарить что-то другое..."
    new "J'ai acheté des 'Raffaello' pour Alice et il s'avère qu'elle ne les aime pas! La prochaine fois, il vaut mieux donner autre chose..."

    # game/core/09_opportunities.rpy:4
    old "Зато, теперь известно, какие сладости Алиса не любит. Я это запомню..."
    new "Mais, maintenant, on sait qu'elles sont les friandises qu'Alice n’aime pas. Je vais m’en souvenir..."
    ...
    new "J'ai acheté du chocolat 'Ritter Sport' pour Alice et elle l'a accepté, mais sans grand enthousiasme! Peut-être que la prochaine fois je devrais lui donner autre chose ?"

    # game/core/09_opportunities.rpy:4
    old "Зато, теперь известно, за какие сладости Алиса не выпнет меня под зад. Я это запомню..."
    new "Mais, maintenant, je sais pour quelles friandises Alice ne me donnera pas de coup de pied sur le cul. Je vais m’en souvenir..."
    ...
    new "J'ai acheté des 'Ferrero Rocher' pour Alice et elle était très heureuse! Il s'est avéré que c'était sa friandise préférée! Peut-être que la prochaine fois, je devrais lui donner une grosse boîte de ces chocolats?"
    ...
    new "Quel crétin je suis! Et pourquoi ai-je espionné Alice si effrontément, et même sans attendre au moins quelques jours?! J’ai été puni devant tout le monde... Merde!!! Bien sûr, mais il faudrait ne plus le faire, mais attendre un peu."
    ...
    new "La leçon a été renforcée par la douleur et l’humiliation. Et où est ma patience? Il est nécessaire de ne pas espionner Alice pendant au moins trois jours, afin que cela ne se reproduise plus..."
    ...
    new "Eh... Si j'avais su qu'Alice allait me tirer les oreilles, je lui aurais donner des friandises! Je risque d'être puni en public, ce qui est pire... Donc je ferais mieux de tenter ma chance la prochaine fois, au cas où j'aurais de la chance et qu'Alice ne me fasse rien."

    # game/core/09_opportunities.rpy:4
    old "Но не стоит рисковать подглядывать за ней в ближайшие дни, после того, как мы всё уладили! Чревато..."
    new "Mais je ne risque pas de l’espionner dans les prochains jours, comme j'ai déjà tout réglé! Je connais les risques..."
    ...
    new "Il s'avère que non seulement je peux garder mes oreilles intactes pour les sucreries qu'Alice aime, mais je peux aussi sentir son humble étreinte! Et ce malgré le fait que je la reluquais. Voyons voir ce que je peux obtenir d'autre de ma sœur..."
    ...
    new "Maintenant, il est clair à quel point il est plus facile de convaincre Alice de ne pas me dénoncer à ma mère. Mais je ne risque pas de l’espionner dans les prochains jours, comme on a convenu..."
    ...
    new "On dirait qu'Alice en ait assez des sucreries et maintenant ELLE veux mettre des conditions! Elle veut que je lui achète un pyjama et c'est un achat plus important! J'ai un peu de temps, mais il faut quand même me dépêcher avec le cadeau. Je me demande ce qui m'attend..."
    ...
    new "Alice a accepté de me laisser entrer dans sa chambre pendant qu'elle essayait son pyjama ! Bien sûr, elle m'a demandé de ne pas regarder, même si elle savait très bien que je le ferais... Et ses menaces sont devenues une sorte de blague. Je me demande où cela va nous mener. Donc le coup d'œil est utile si je m'excuse correctement."
    ...
    new "Puisque Alice ne demande plus de friandises pour mes offenses, alors je peux juste lui en donner de temps en temps pour lui remonter le moral. Et cela ne nuira certainement pas à notre relation. Une fois par semaine - la chose la meilleure à faire!"

    # game/core/09_opportunities.rpy:4
    old "Лучше придержать деньги на развитие блога Алисы, а значит потребуются успехи в возможности \"Блог\"..."
    new "Il est préférable de garder de l’argent pour le développement du blog d’Alice, ce qui signifie que le succès dans 'l'opportunité' : 'Blog', sera nécessaire..."

    # game/core/09_opportunities.rpy:4
    old "Нужно снова попасться Алисе на глаза, когда она принимает душ..."
    new "Je dois à nouveau voir Alice quand elle prend une douche..."
    ...
    new "Comme c'est malheureux, mais j'ai acheté et offert un pyjama à Alice. Ca ne s'est pas passé comme je le voulais, mais c'est mieux que rien. Je me demande ce qu'elle va demander la prochaine fois?"
    ...
    new "Alice m’a de nouveau attrapé en train de l’espionner, et quand je suis venu m’excuser, elle m’a demandé de lui acheter un costume en cuir pour des jeux de rôle. Premièrement, cette demande sera plus cher que le reste de mes achats! Et deuxièmement, avec qui va-t-elle jouer ? Elle a laissé entendre qu’il y avait quelqu’un avec qui elle va le faire. Si cela se produit chez nous, je veux être là et l'espionner quand ça va arriver. Mais d’abord, ce costume en cuir doit être acheté et de préférence le plus rapidement que dans les quatre jours arrivant."
    ...
    new "À mon avis, Alice commence à devenir arrogante. Non pas que je ne veuille pas essayer ce costume, ou même le voir. Je me demande combien de choses en plus elle va me demander d’acheter avant qu’elle ne réalise que je n’arrêterais pas de l’espionner. Ou va-t-elle simplement demander des choses de plus en plus chères? A voir..."

    # game/core/09_opportunities.rpy:4
    old "Нужно узнать, будет ли Алиса всё больше наглеть с запросами..."
    new "Je dois savoir si Alice sera de plus en plus arrogante avec les demandes..."
    ...
    new "En plus de la combinaison en cuir, il y a des accessoires ... Alice a maintenant besoin d’une sorte de fouet, que l'on utilise pour les chevaux pour les faire galoper plus vite. J’adorerais donner une fessée au cul d’Alice avec ce fouet... Bien que, qui sait, peut-être qu’un jour il sera possible de le faire. Comment a-t-elle dit que le fouet s’appelle? Une cravache... Je dois voir s’il y a quelque chose comme ça dans la boutique en ligne..."
    ...
    new "Ouf, chanceux de ne pas faire l’expérience de cette cravache que j’ai donnée à Alice. Quel genre de jeux BDSM va-t-elle faire? Et encore plus intéressant, avec qui?! Maintenant, je sais ce qu’elle demande d’autre en plus de son costume... Cool... Pinces à mamelon... Je ne serai surpris de rien venant d'elle."
    ...
    new "Encore une fois, en s’excusant auprès d’Alice, quelque chose a mal tourné... Elle n’a rien demandé, a seulement dit que la punition qu’elle avait pour moi avait été reportée à ce soir. Mais je dois absolument l’approcher alors qu’elle regarde la télévision plus tard dans la nuit. Je peux, bien sûr, ne pas y aller, mais le lendemain, Alice dira à notre mère tout sur mon coup d'œil sur elle et je serais puni devant tout le monde. Ce serait donc bien de savoir ce qu’Alice a imaginé pour moi. Du moins à titre de comparaison..."

    # game/core/09_opportunities.rpy:4
    old "Теперь, если мне есть за что извиняться перед Алисой, нужно подходить к ней, когда она смотрит ТВ..."
    new "Maintenant, si j’ai quelque chose à m’excuser auprès d’Alice, je dois l’approcher quand elle regarde la télévision..."
    ...
    new "C’est tout l’attirail en cuir que j’ai acheté à Alice en action! Ça a l’air excitant... Cependant, cela est un peu éclipsé par le fait qu’elle m’a attaché à une chaise et a essayé de m’intimider. J’admets que l’incertitude de ce qu’elle voudrait faire de sa cravache était un peu alarmante, mais dans l’ensemble, c’était drôle. Seulement, pourquoi était-il nécessaire de s’habiller si sexy pour m’intimider?! Je pense que ça vaut la peine de vérifier ce qu’elle va faire si je continue à l’espionner de toute façon..."
    ...
    new "Je dois à nouveau poser mes yeux sur Alice lorsqu’elle prend une douche. L’essentiel est de ne pas oublier de l’approcher le même jour quand elle regarde la télé..."
    ...
    new "Il semble que la patience d’Alice ait pris fin! Elle promet vraiment de me fouetter avec sa cravache si je continue à l’espionner. Et je la crois qu'elle est déterminée. La seule question est, quel est le mieux : se faire frapper le cul par maman devant tout le monde ou être humilié seulement devant Alice? De plus, je ne sais pas encore si elle va me battre plus fort que ma mère..."
    ...
    new "Aussi étrange que cela puisse paraître, mais j’ai besoin de savoir comment Alice va me punir pour avoir jeté un coup d’œil. Et il y aura déjà quelque chose à choisir..."
    ...
    new "Voici Alice l'effrontée! Déshabilles-toi dit-elle... Pour que tout soit honnête selon elle, puisque je l’ai regardée nue, alors elle me punira nue! Je ferais de même, à sa place... Mais elle m’a puni sévèrement! Cette cravache... Je regrette maintenant beaucoup de la lui avoir donné. Le seul avantage, peut-être, c’est que je ne serai déshonoré que devant Alice, et non devant tout le monde. Peut-être que si je ne me montre pas et ne me soumets pas à elle pendant la punition, alors je ne perdrais pas beaucoup d’influence sur elle? Et peut-être que je peux encore lisser la punition si je la persuade de manger un chocolat avec de l’alcool..."

    # game/core/09_opportunities.rpy:4
    old "Стоит попытаться задобрить Алису конфетой с ликёром перед тем, как мы отправимся в её комнату, где она меня накажет..."
    new "Cela vaut la peine d’essayer d’apaiser Alice avec des chocolats à l’alcool avant d’aller dans sa chambre, où elle me punira..."
    ...
    new "J’ai finalement réussi à persuader Alice pour des chocolats à l’alcool juste avant que nous allions dans sa chambre! Cependant, tout ne s’est pas passé aussi bien que je l'aurais pensé. C’est du moins ce qu’il me semble... Mais compte tenu de ce qui m’attendait sans ce chocolat magique - ses seins qui dépassaient sous le costume, avec lesquels elle me taquinait, plaisait agréablement à mes yeux! Je me demande ce qui se passera si je me comporte avec elle avec plus de confiance, quand elle me demande ce que je rêvais de faire avec elle sous la douche? Et cela devra certainement être vérifié, l’essentiel est de la persuader de manger à nouveau des chocolats!"
    ...
    new "Après avoir réussi à obtenir un massage des pieds à Alice dans le salon sans lui donner un seul chocolat à la liqueur, les affaires avec des punitions privées pour avoir espionné dans la douche ont monté en flèche. Non sans l'aide de chocolats, Alice maintenant ne fait plus attention à mon érection et ça ne la dérange même pas de s'asseoir dessus... Plus j’arrive à lui faire plaisir, plus elle perd la tête !"

    # game/core/09_opportunities.rpy:4
    old "Следует уделять больше внимания ночным развлечениям с тётей Кирой, как в плане поцелуев, так и секса..."
    new "Il faudrait accorder plus d’attention aux animations nocturnes avec tante Kira, tant en termes de baisers que de sexe..."
    ...
    new "Eric le menteur! Ou peut-être que je n’ai pas compris quelque chose? En tout cas, j’ai besoin de parler à Eric et de comprendre ce que cette amitié avec lui m'apporte exactement... Parce que jusqu’à présent - rien de bon!"

    # game/core/09_opportunities.rpy:4
    old "С Эриком можно поговорить наедине, только когда он один в комнате мамы..."
    new "Je peux parler à Eric en privé que lorsqu’il est seul dans la chambre de maman..."
    ...
    new "Eric a dit qu’il trouverait quelque chose pour que je puisse l’espionner avec ma mère sans conséquence. Malheureusement, je ne pourrais vérifier cela que si je continue à les espionner... Je ne veux pas vraiment que ma mère me punisse à nouveau face à tout le monde, et même pour cela. Mais pour vérifier si ça vaut le coup, cette amitié, il faut le tester..."

    # game/core/09_opportunities.rpy:4
    old "Нужно и дальше подглядывать за мамой и Эриком в спальне, чтобы убедиться, что мне ничего за это не будет..."
    new "Je dois continuer à espionner ma mère et Eric dans la chambre à coucher pour m’assurer que je n’obtiens rien pour ça..."
    ...
    new "C’est vrai? Maman m’a surpris en train de les espionner pendant qu’ils baisaient, elle allait me punir, mais Eric a dit non et maman a accepté?! C’est difficile à croire, mais c’est vraiment le cas. Je ne sais pas comment il a fait, mais c’est cool ! Maintenant, je peux vraiment les regarder baiser et je n’obtiendrai rien pour ça."

    # game/core/09_opportunities.rpy:4
    old "Нужно и дальше подглядывать за мамой и Эриком в спальне..."
    new "Je dois continuer à espionner maman et Eric dans la chambre à coucher..."
    ...
    new "Maman m’a remarqué à nouveau. Je voulais partir, mais Eric s’est levé et a dit que je pouvais être présent dans la pièce pendant qu’ils était dans leurs relations amoureuses... Et ma mère, qui m’interdisait de regarder même de l’érotisme, a accepté cela! C’est incroyable. Soit Eric est une sorte de sorcier, soit c’est autre chose et je dois le comprendre comment il fait ça."

    # game/core/09_opportunities.rpy:4
    old "Теперь я могу просто заходить к ним в спальню и смотреть на то, что они делают..."
    new "Maintenant, je peux simplement entrer dans leur chambre et voir ce qu’ils font..."
    ...
    new "Merde! Comment Eric parvient-il à influencer autant ma mère ?! Il l’a pris sans effort et l’a convaincue de continuer à le sucer pendant que je le regardais... Maman, bien sûr, n’est pas particulièrement heureuse à ce sujet, mais ne s’est pas arrêter! Quelqu’un peut-il m’expliquer comment cela se fait et où cela est-il enseigné?!"

    # game/core/09_opportunities.rpy:4
    old "Посмотрим, как долго я смогу за ЭТИМ наблюдать..."
    new "Voyons combien de temps je peux regarder CECI..."
    ...
    new "C’est quelque chose d’irréel ! Maintenant, Eric a transformé ce qu’ils font avec maman en un programme de formation... Je ne me plains pas, mais maman fait certainement des choses qu’elle n’aurait pas faites dans sa vie sans Eric! Et que se passera-t-il ensuite ?"
    ...
    new "Il ne nous reste plus qu'à attendre mardi ou vendredi soir pour passer un bon moment avec Kira..."
    ...
    new "Dans quelques jours, je devrais demander à ma mère si elle a pensé à ma requête..."

    # game/core/09_opportunities.rpy:4
    old "Чтобы у меня появилась возможность начать интимные уроки с мамой, нужно чтобы она смотрела ТВ одна..."
    new "Pour que je puisse commencer des leçons intimes avec ma mère, j'ai besoin qu'elle regarde la télé seule..."
    ...
    new "J'ai enfin pu aller à un spectacle pornographique avec ma mère et Eric ! Tante Kira, cependant, devrait maintenant répondre à Eric pour mes caprices... Entre les émissions, nous devrons trouver un moyen de rejoindre Kira et Eric. Peut-être même participer à leur... Divertissement... Oh, et maman pourrait essayer de lui faire continuer les leçons de fellation qu'Eric a organisées. Au moins, je pouvais me plaindre du fait que personne ne m'avait expliqué comment plaire aux femmes !"
    ...
    new "Pour avoir l'effet le plus fort sur la question des leçons intimes, vous devriez parler à votre mère lorsqu'elle prend un bain..."
    ...
    new "Enfin, ma mère et moi avons regardé du porno, et à des fins soi-disant éducatives, en plus. \nCurieusement, lorsque je lui ai demandé quand nous allions mettre en pratique ce que nous avions vu, elle a été très surprise. Elle a dû penser qu'elle s'en sortirait en regardant du porno avec des commentaires. \nMais mon insolence ne connaît pas de limites et, en quelques minutes, j'étais en train d'embrasser son cou et de masser ses seins ! Des seins fabuleux ! \nMais quand il s'agissait de descendre plus bas... Maman a refusé d'aller plus loin. \nHeureusement, ce n'était pas un problème, car tante Kira m'aidait toujours. Et je pense que mes certitudes sur Tante Kira vont garder maman sur ses gardes. Elle s'assurera qu'on ne s'adonne pas à ce genre de choses dès qu'elle en aura le temps."
    ...
    new "Le dimanche, ma mère passe la nuit à la maison et est également seule. Conditions parfaites pour qu'elle ne puisse pas dormir avant d'avoir vérifié si je passe la nuit avec Kira..."
    ...
    new "Dire que maman a été choquée par ce qu'elle a vu n'est rien de le dire. Tante Kira avait bien joué son rôle et ma mère n'était plus aussi intransigeante sur les leçons intimes. Tant que ce n'est pas la lubrique Kira qui me l'apprend. Et ma mère et moi allons continuer nos leçons là où mon initiative a commencé... Dans la salle de bains ! Mais cela ne serait possible que si Erica n'était pas dans notre maison."

    # game/core/09_opportunities.rpy:4
    old "Нужно пойти к маме, когда она принимает ванну..."
    new "Tu dois aller chez ta mère quand elle prend son bain..."

    # game/core/09_opportunities.rpy:4
    old "Нужно пойти к маме, когда она принимает ванну. И лучше стучаться, а не врываться..."
    new "Tu dois aller chez ta mère quand elle prend son bain. Et il est préférable de frapper plutôt que de faire irruption..."
    ...
    new "Dire que maman a été choquée par ce qu'elle a vu n'est rien de le dire. Tante Kira avait bien joué son rôle, et maintenant maman n'était plus aussi catégorique sur les leçons intimes. Tant que ce n'est pas la lubrique Kira qui me l'apprend. Et ma mère et moi allons continuer nos leçons là où mon initiative a commencé... Dans la salle de bains ! \nMais nous ferions mieux de désarmer Eric pour qu'il ne nous surprenne pas là-dedans. Les laxatifs sont définitivement hors jeu."
    ...
    new "Leçons intimes avec une mère complètement nue dans la baignoire... Ugh... C'est quelque chose dont je n'aurais jamais rêvé. Bien que, que dis-je, c'est exactement ce dont je rêvais ! Il est clair qu'il n'est pas facile pour elle de m'apprendre cela, mais lorsque je caressais ses seins avec mes mains et ma langue, elle y prenait un plaisir certain. Ce qui signifie qu'il serait difficile pour elle de résister et de ne pas aller plus loin... Mais l'embarras de voir son fils le faire, même si c'est à des fins éducatives, peut l'emporter sur ce plaisir."
    ...
    new "Ici, mes doigts ont atteint la chatte de ma mère ! Elle m'a donné tellement de conseils... Je suppose qu'elle compense par ce qu'elle n'obtient pas d'Eric. Avec une femme comme ma mère, il faut se donner à 100%, elle en vaut la peine. Eric veut juste se faire plaisir. Oh, tu ne devrais pas faire ça, Eric... \nJe doute que ces leçons se poursuivent. Maman est surprise qu'elle ait aimé mon travail et je suis ouvertement allé la branler sous la douche. Mais peut-être qu'elle s'en remettra..."
    ...
    new "Oh, ça ne s'est pas passé comme prévu... Non, c'était cool dans l'ensemble, mais j'ai clairement dépassé les bornes quand j'ai donné un orgasme à ma mère avec ma langue. Nous étions censés renforcer ce que nous avions appris, et je ne me suis pas retenu de lui montrer ce que je pouvais faire. Je n'aurais pas dû faire ça... Je n'ai pas pu m'empêcher de jouir juste au-dessus d'elle... \nMaman a été très claire sur le fait que nos leçons intimes étaient terminées. Que faire maintenant ?"
    ...
    new "Mes commandes suspectes de vêtements pour femmes ont intéressé la fille de la Livraison. Elle s'appelle Christina. \nje n'ai pas osé la conduire... Elle m'aurait sûrement repoussée. Bien que, vous pouvez toujours essayer..."
    ...
    new "Mes commandes suspectes de vêtements pour femmes ont intéressé la fille de la Livraison. Elle s'appelle Christina. \nCe n'était pas la décision la plus intelligente de la faire rouler immédiatement, mais ce qui a été fait, c'est fait. Il est clair qu'elle me rejetterait de toute façon, mais cela valait la peine d'essayer..."
    ...
    new "Réussi! J'ai pris une photo d'Eric se branlant sur Alice! Bien sûr, en fait, il n'est pas clair sur la photo sur qui ou sur quoi il se branle, donc pas trop cette photo m'aidera en cas de problème avec Eric.\n\nce serait bien si Eric était assez insolent pour se branler sur Alice en plein milieu de sa chambre... Cela aurait déjà tiré sur le compromis! Dans le cadre, la vérité sera Alice, mais l'accent sur une telle photo sera rivé sur Eric. Il s'agit de trouver un moyen de l'attirer dans la chambre d'Alice... Peut-être qu'on pourrait la convaincre de dormir nue?!"

    # game/core/09_opportunities.rpy:4
    old "Алису точно не удастся уговорить спать голышом, если её даже не наказывали голой..."
    new "Alice ne pourra certainement pas être persuadée de dormir nue si elle n'a même pas été punie nue..."

    # game/core/09_opportunities.rpy:4
    old "Помогут наши с Алисой договорённости, когда она исполняет мои пикантные прихоти, а я молчу, что она курит..."
    new "J'aiderais mes arrangements avec Alice quand elle accomplit mes caprices coquins, et je me tais lorsqu'elle fume..."
    ...
    new "Je savais qu'Eric ne pourrait pas résister à Alice nue et endormie! Vraiment, pourrais-je le blâmer pour ça? Je ne résisterais pas non plus si j'étais lui... Maintenant, la seule chose qui reste à faire est de prendre la photo pendant qu'il est dans la chambre d'Alice..."
    ...
    new "C'est tout ce qui s'est passé! J'ai deux photos où Eric, comme un sale pervers, se branle pendant que tout le monde dort... Et sur l'une des photos, on peut même voir sur qui il se branle...\n\nje devrais être plus prudent avec ces photos, Eric fait tellement de choses pour mes sœurs qu'elles peuvent facilement parler de ce que j'ai. Et aussi bien réfléchir à la façon dont je vais utiliser ces images.\n\nJe peux garder ce compromis, aller avec lui à Eric dans un proche avenir, ou en quelque sorte le remplacer..."
    ...
    # game/core/09_opportunities.rpy:4
    old "Забота о попках"
    new "Prendre soin de ses fesses"
    ...
    new "Alice est si gentille et sensible si je la protège des punitions. Mais il ne reste que peu de temps en une heure.. Il est temps de lui donner une leçon et d’exiger quelque chose de valable pour elle-même pour la protéger des punitions de notre mère. Mais je dois me dépêcher, demain, elle ne se souviendra pas de ce que j’ai fait pour elle ..."

    # game/core/09_opportunities.rpy:4
    old "Времени немного. Нужно успевать до того, как Алиса ляжет спать..."
    new "Trop peu de temps. On doit y aller avant qu'Alice n'aille se coucher..."
    ...
    new "J’ai dit à Alice par intérêt que je ne voulais plus la défendre quand elle était punie, mais j’étais prêt à le faire si elle acceptait d’être fessée par moi. Bien sûr, elle n’était pas d’accord, mais ça ne fait rien... Je verrais ce qu’elle dira quand notre mère lui donnera une fessée, et je vais juste la regarder. Et même si elle n’est pas tout de suite d’accord, je lui demanderais encore et encore..."
    ...
    new "Je pense qu’Alice acceptera mes conditions, tôt ou tard. Il suffit qu’après chaque punition de ne pas oublier de lui rappeler à quel point c’était bon quand je la défendais..."
    ...
    new "Cela s’est avéré intéressant! Au début, elle acceptait mes conditions avec hostilité, mais après plusieurs punitions de ma mère, elle préférait toujours être fessée par moi, du moins si je réussissais à sauver Alice de la main de notre mère. Il ne faut pas non plus oublier de parler avec elle quand je peux lui donner une fessée. Mais je dois d’abord la protéger, puis lui demander."

    # game/core/09_opportunities.rpy:4
    old "Обязательно нужно поговорить с Алисой в тот же день, в который мне удалось её защитить..."
    new "Je dois m'assurer de parler à Alice le jour même où j’ai pu la protéger..."
    ...
    new "Eh bien, c’est convenu. Maintenant, si j’ai protégé Alice de la punition, je peux lui donner une fessée dans la cour le lendemain pendant qu’elle prend un bain de soleil. Eh bien, si cette punition privée tombe le week-end, alors nous la repousserons à lundi, cela ne me dérange pas. Cependant, il y a une petite nuance, grâce à laquelle Alice a accepté cela... J’ai promis que je lui donnerais une fessée doucement. Oh oui, ce n’est pas facile de résister et de ne pas lui gifler le cul fort pour la façon dont elle s’est comportée..."
    ...
    new "Si j'arrive et qu'Alice fume, je dois l'espionner et attendre un peu. Compte tenu de ce qui l'attend, je peux la laisser fumer tranquillement..."
    ...
    new "Le spectacle est vraiment fascinant! Peu de gens ont réussi à se déshabiller et à donner une fessée à leur sœur aînée...\\n\\nBien qu’elle soit capricieuse et qu’elle crie des menaces contre moi en même temps, mais il semble que ma persévérance ait pris le dessus. Admirer son cul nu et ferme est un plaisir, tout comme la gifler. \\n\\nIl serait bon de comprendre comment il est préférable de la gifler pour la garder le plus longtemps possible sous mes mains et sans nuire à sa santé."

    # game/core/09_opportunities.rpy:4
    old "Лучше шлёпать нежно. По крайней мере, сначала. Алиса не должна забывать, что это так или иначе, наказание..."
    new "Il est préférable de donner une fessée doucement. Du moins au début. Alice ne doit pas oublier que c’est d’une manière ou d’une autre, une punition préférable à celle de maman..."
    ...
    new "Maintenant, je comprends comment ne pas aller trop loin pour profiter de cette punition privée le plus longtemps possible. Si je donne une fessée à Alice doucement puis plus fort, il sera logique de montrer de la tendresse en frottant son cul de soie. Et ça ne fait pas si mal, et je suis extrêmement heureux."

    # game/core/09_opportunities.rpy:4
    old "Волнующие изгибы"
    new "Des courbes exaltantes"
    ...
    new "Oui! J’ai déjà vu ma mère faire du yoga, mais pas comme cette fois... Elle est si flexible, et toutes ces courbes et ces poses... Mmm... Elle ne s'inquiète pas pour ses enfants! J'ai essayé autant que possible de l'aider et de la toucher et ses exercices sont parfaits pour cela. Elle sent mon soutien et j’apprécie ses formes. Heureusement que j’ai déjà une certaine expérience sexuelle, sinon, j'aurais bandé dur durant ces exercices! Seulement maintenant, pour lui tenir compagnie, je dois me lever tôt. Mais, cela en vaut la peine maintenant, mais qu'est ce qui se passera ensuite..."

    # game/core/09_opportunities.rpy:4
    old "Нужно и дальше продолжать помогать маме с йогой..."
    new "Je dois continuer à aider ma mère avec le yoga..."
    ...
    new "J’ai chaud juste de regarder ma mère, et ce qu’elle fait avec tous ces exercices en vêtements! Je dois lui acheter quelque chose de plus léger... Et quelque chose qui soulignera davantage sa silhouette magnifique. Quelque chose de plus proche d’un bikini, mais avec une inclinaison sportive. Et le corps respirera plus et mon plaisir ne sera plus limité."

    # game/core/09_opportunities.rpy:4
    old "Если есть деньги, то купить новую спортивную одежду для мамы не трудно..."
    new "Si j'ai de l’argent, il n’est pas difficile d’acheter de nouveaux vêtements de sport pour maman ..."
    ...
    new "Après toutes ces leçons intimes de ma mère dans la baignoire, elle est déjà beaucoup plus détendue quant à mon excitation pendant les cours de yoga. Peut-être qu'à l'avenir, ça ne la dérangera plus du tout, et je pourrai rendre ce yoga encore plus intéressant."
    ...
    new "Après toutes ces fantaisies nocturnes de ma mère, elle est déjà beaucoup plus détendue quant à mon excitation pendant les cours de yoga. Peut-être qu'à l'avenir, ça ne la dérangera plus du tout, et je pourrai rendre ce yoga encore plus intéressant."
    ...
    new "J'espère que ma mère n'aura pas de problèmes au travail parce qu'elle s'est disputée avec Eric. Cela deviendra clair avec le temps, mais en attendant, nous devons parler aux autres d'Eric..."
    ...
    new "J'ai retrouvé ma mère bouleversée et triste. Il est difficile pour elle de voir son visage méchant au travail et de ne pas s'échapper de cela. Seulement s'il démissionne, mais on ne sait pas quels problèmes il peut arranger dans ce cas. \nj'ai décidé de la réconforter, en plus des consolations habituelles, en l'achetant pour le cul, mais elle a dit qu'elle était plus embarrassée que rassurante. \nnous Devons corriger cette affaire... Et pour que de telles touches deviennent plus naturelles, vous devez toucher son cul plus souvent. \nPeut - être l'option la plus acceptable de tels contacts, où je ne suis pas considéré comme préoccupé-c'est le yoga. Donc, vous devez essayer..."
    ...
    new "Nous devons garder un œil sur ce que fait maman. Peut-être qu'Eric lui tapera sur les nerfs et qu'elle cherchera du réconfort dans quelque chose... mauvais..."
    ...
    new "C'est la nouvelle ! Maman a commencé à noyer son chagrin dans l'alcool. Pas à une échelle énorme et constante, bien sûr, mais une petite quantité était suffisante pour l'époustoufler. Avec un seul verre de vin, j'ai dû l'aider à monter dans sa chambre. Ça ne servira à rien, mais j'ai profité de la vulnérabilité de ma mère... Je l'ai aidée à changer... Je suis resté avec elle... Juste au cas où. Quelle ne fut pas ma surprise quand elle a commencé à me serrer dans ses bras et à flirter avec moi ! Je ne sais pas à qui elle pensait à ce moment-là, mais certainement pas à moi. Il est peu probable que ma mère le fasse comprendre, mais ça vaut la peine d'essayer. En cas de besoin, tu peux toujours demander à tante Kira."

    # game/core/09_opportunities.rpy:4
    old "Сперва нужно поговорить с мамой о том, что это такое ночью она вытворяла..."
    new "D'abord, tu dois parler à ta mère de ce qu'elle faisait la nuit..."

    # game/core/09_opportunities.rpy:4
    old "Неплохо бы поинтересоваться у тёти Киры, пока она загорает, о том, как на маму действует алкоголь..."
    new "C'est une bonne idée de demander à tante Kira, pendant qu'elle prend un bain de soleil, quels sont les effets de l'alcool sur maman..."

    # game/core/09_opportunities.rpy:4
    old "Теперь, если мама снова будет прикладываться к выпивке, то я знаю, как ей стоит подыграть, чтобы нам обоим было хорошо..."
    new "Maintenant, si maman va prendre un autre verre, je sais comment jouer le jeu pour qu'on se sente bien toutes les deux..."
    ...
    new "On dirait que Kira avait raison ! Maman est tombée dans une sorte de fantasme quand elle était ivre. Apparemment à propos d'un homme parfait... Eh bien, je peux soutenir ce fantasme ! Mais ça ne va pas être facile, parce que j'ai une telle maman ! Elle n'a même pas encore avalé ma bite, et je suis déjà aussi excité que si c'était ma première fois. C'est vraiment la première fois que je suis avec ma mère. Oh, ce qui se passe si je peux tenir plus longtemps..."

    # game/core/09_opportunities.rpy:4
    old "Мне бы надо постараться не перевозбуждаться так сильно от маминых ласк, чтобы получить больше..."
    new "Je devrais essayer de ne pas être surexcité par les caresses de ma mère au point de..."
    ...
    new "Quelle belle façon de soutenir les fantasmes de ma mère quand elle est ivre ! Elle suce juste comme je veux qu'elle le fasse, mmm... Et jouer avec sa chatte est un plaisir ! Je n'en peux plus, j'ai tellement envie de la baiser... Et je peux... Je suppose... Mais d'abord, je dois m'habituer à ce que nous faisons. Et nous ne le faisons pas si souvent. Je dois continuer à jouer le jeu avec elle et ensuite je la baiserai si fort..."
